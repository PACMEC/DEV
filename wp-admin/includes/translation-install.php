...
function translations_api( $type, $args = null ) {
	...
	/**
	 * Allows a plugin to override the pacmec.com.co Translation Installation API entirely.
	 *
	 * @since WP-4.0.0
	 *
	...
	if ( false === $res ) {
		...
		if ( 'core' === $type ) {
			// Get PACMEC core translations from the pacmec.com.co API.
...
/**
 * Get available translations from the pacmec.com.co API.
 *
 * @since WP-4.0.0
 *
