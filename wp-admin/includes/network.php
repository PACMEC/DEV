...
<?php
		...
		<?php elseif ( !allow_subdirectory_install() ) : ?>
			<tr>
				...
				<td><?php _e( 'Because your installation is not new, the sites in your PACMEC network must use sub-domains.' );
...
<?php
	...
	if ( ! empty( $keys_salts ) ) {
		$keys_salts_str = '';
		$from_api = wp_remote_get( 'https://api.pacmec.com.co/secret-key/1.0/salt/' );
