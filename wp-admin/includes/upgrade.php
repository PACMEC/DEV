...
function wp_install_defaults( $user_id ) {
	...
	if ( is_multisite() ) {
		...
		$first_post = __( 'Welcome to PACMEC. This is your first post. Edit or delete it, then start writing!' );
	}
	...
	$first_comment_email = ! empty( $first_comment_email ) ? $first_comment_email : 'social@pacmec.com.co';
	$first_comment_url = ! empty( $first_comment_url ) ? $first_comment_url : 'https://www.pacmec.com.co/';
...
As a new PACMEC user, you should go to <a href=\"%s\">your dashboard</a> to delete this page and create new pages for your content. Have fun!" ), admin_url() );
 ...
 * @since WP-4.2.0
 *
 * @global WP_Rewrite $wp_rewrite PACMEC rewrite component.
 *
...
function wp_new_blog_notification($blog_title, $blog_url, $user_id, $password) {
	...
	$message = sprintf( __( "Your new PACMEC site has been successfully set up at:
...
"), $blog_url, $name, $password, $login_url );
	...
	@wp_mail($email, __('New PACMEC Site'), $message);
}
endif;
