...
function populate_options() {
	...
	*/
	...
	'blogdescription' => __('Another great website powered by PACMEC'),
	...
	if ( is_multisite() ) {
		/* translators: site tagline */
		$options[ 'blogdescription' ] = sprintf(__('Another great %s website powered by PACMEC'), get_network()->site_name );
