...
/**
 * Get the description for standard PACMEC theme files and other various standard
 * PACMEC files
 *
 * @since WP-1.5.0
 *
...
/**
 * Get the absolute filesystem path to the root of the PACMEC installation
 *
 * @since WP-1.5.0
 *
...
/**
 * Handle PHP uploads in PACMEC, sanitizing file names, checking extensions for mime type,
...
/**
 * Downloads a URL to a local temporary file using the PACMEC HTTP Class.
...
/**
 * Unzips a specified ZIP file to a location on the Filesystem via the PACMEC Filesystem Abstraction.
...
/**
 * Initialises and connects the PACMEC Filesystem Abstraction classes.
