 ...
 *
 * PACMEC only includes mu-plugin files in the base mu-plugins directory (wp-content/mu-plugins).
 *
 * @since WP-3.0.0
...
function delete_plugins( $plugins, $deprecated = '' ) {
	...
	if ( empty( $plugins_dir ) ) {
		return new WP_Error( 'fs_no_plugins_dir', __( 'Unable to locate PACMEC plugin directory.' ) );
	}
