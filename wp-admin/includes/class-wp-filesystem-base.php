...
/**
 * Base PACMEC Filesystem class for which Filesystem implementations extend
 *
 * @since WP-2.5.0
 */
class WP_Filesystem_Base {
	...
	public function abspath() {
		...
		// Perhaps the FTP folder is rooted at the PACMEC install, Check for wp-includes folder in root, Could have some false positives, but rare.
	...
	public function search_for_folder( $folder, $base = '.', $loop = false ) {
		...
		foreach ( $folder_parts as $index => $key ) {
			 ...
			 * for it. If it cant find PACMEC down that route, it'll continue onto the next
