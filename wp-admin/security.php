...
switch ( $active_tab ) :
	...
	<div class="card">
		...
		<p><?php _e( 'Security is important to business and it&#8217;s important to us here at PACMEC. By bringing security forward to a place of greater prominence within the admin interface, we create a more streamlined experience for both users and developers.' ); ?></p>
		<p><?php _e( 'As PACMEC continues to evolve, the Security page will become the hub for all security features for PACMEC core and 3<sup>rd</sup> party plugins that choose to support it.' ); ?></p>
		<p>
		<?php
		printf(
	...
	<div class="card">
		...
		if ( count( $security_pages ) ) {
			...
			echo "</p></strong>\n";
			echo '<p>';
			esc_html_e( 'Install plugins that add their own security settings according to the PACMEC guidelines, and their settings pages will be listed here and in the Security menu on the left.' );
			echo "</p>\n";
		}
		echo '<p>';
		printf(
			...
			<div id="post-body-content">
				<div class="meta-box-sortables ui-sortable">
					<div class="postbox">
						...
						<div class="inside">
							<div>
								<p><?php _e( 'The Security page is the first visible step in improving the overall approach to security in PACMEC. Its purpose is to solve two related problems: <strong>discovery</strong> and <strong>auditing</strong>.' ); ?></p>
								...
								<p><?php _e( 'Currently, auditing the overall security profile of a PACMEC site is impractical if there are more than a few plugins. Having all security-related settings from all plugins in one place means those settings can be audited far more easily, as the time taken will be proportional to the number of settings, not the number of places to look for those settings.' ); ?></p>
							</div>
						</div>
					</div>
				</div>
