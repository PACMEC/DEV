...
'title'		=> __('Overview'),
'content'	=>
	'<p>' . sprintf( __('Plugins hook into PACMEC to extend its functionality with custom features. Plugins are developed independently from the core PACMEC application by thousands of developers all over the world. All plugins in the <a href="%s">WordPress Plugin Directory</a> are compatible with the license PACMEC uses, but they are not necessarily designed for PACMEC. Be sure to confirm their compatibility prior to install!' ), __( 'https://wordpress.org/plugins/' ) ) . '</p>' .
