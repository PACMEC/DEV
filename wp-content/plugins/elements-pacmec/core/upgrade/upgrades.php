...
/**
 * Elements PACMEC upgrades.
 *
 * Elements PACMEC upgrades handler class is responsible for updating different
 * Elements PACMEC versions.
 *
 * @since 1.0.0
 */
class Upgrades {
	...
	/**
	 * Upgrade Elements PACMEC 0.11.0
	 *
	...
	/**
	 * Upgrade Elements PACMEC 2.0.10
	 *
	 * Fix post titles for old autosave drafts that saved with the format 'Auto Save...'.
