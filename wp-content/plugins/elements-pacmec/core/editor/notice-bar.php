...
// TODO: Remove or change in future versions of Elements PACMEC
class Notice_Bar extends Base_Object {
	...
	protected function get_init_settings() {
		...
		return [
			...
			'message' => __( 'Love using Elements PACMEC? <a href="%s">Learn how you can build better sites with Elementor Pro.</a>', 'elementor' ),
