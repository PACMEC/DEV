...
/**
 * Elements PACMEC frontend.
 *
 * Elements PACMEC frontend handler class is responsible for initializing Elements PACMEC in
 * the frontend.
 *
 * @since 1.0.0
 */
class Frontend extends App {
	...
	/**
	 * Whether the page is using Elements PACMEC.
	 *
	 * Used to determine whether the current page is using Elements PACMEC.
	 *
	 * @since 1.0.0
	 * @access private
	 *
	 * @var bool Whether Elements PACMEC is being used. Default is false.
	 */
	 ...
	 * conflicted with Elements PACMEC while processing the content.
	 *
	 * @since 1.0.0
	 * @access private
	 *
	 ...
	 *
	 * Initializing Elements PACMEC front end. Make sure we are not in admin, not and
	 * redirect from old URL structure of Elements PACMEC editor.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 * Init.
	 *
	 * Initialize Elements PACMEC front end. Hooks the needed actions to run Elements PACMEC
	...
	public function init() {
		...
		// Add Edit with the Elements PACMEC in Admin Bar.
	 ...
	 * Add content filter.
	 *
	 * Remove plain content and render the content generated by Elements PACMEC.
	 *
	 * @since 1.8.0
	 * @access public
	 */
	 ...
	 *
	 * When the Elements PACMEC generated content rendered, we remove the filter to prevent multiple
	 * accuracies. This way we make sure Elements PACMEC renders the content only once.
	 *
	 * @since 1.8.0
	 * @access public
	 */
	...
	public function register_scripts() {
		 ...
		 *
		 * Fires before Elements PACMEC frontend scripts are registered.
		 *
		 * @since 1.2.1
		 */
		 ...
		 *
		 * Fires after Elements PACMEC frontend scripts are registered.
		 *
		 * @since 1.2.1
		 */
	...
	public function register_styles() {
		 ...
		 *
		 * Fires before Elements PACMEC frontend styles are registered.
		 *
		 * @since 1.2.0
		 */
		 ...
		 *
		 * Fires after Elements PACMEC frontend styles are registered.
		 *
		 * @since 1.2.0
		 */
	...
	public function enqueue_scripts() {
		 ...
		 *
		 * Fires before Elements PACMEC frontend scripts are enqueued.
		 *
		 * @since 1.0.0
		 */
		 ...
		 *
		 * Fires after Elements PACMEC frontend scripts are enqueued.
		 *
		 * @since 1.0.0
		 */
	...
	public function enqueue_styles() {
		 ...
		 *
		 * Fires before Elements PACMEC frontend styles are enqueued.
		 *
		 * @since 1.0.0
		 */
		...
		foreach ( $this->fonts_to_enqueue as $key => $font ) {
			...
			switch ( $font_type ) {
				...
				default:
					 ...
					 * Print font links.
					 *
					 * Fires when Elements PACMEC frontend fonts are printed on the HEAD tag.
					 *
	 ...
	 *
	 * Used to apply the Elements PACMEC page editor on the post content.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Used to render and return the post content with all the Elements PACMEC elements.
	 *
	...
	/**
	 * Add Elements PACMEC menu to admin bar.
	 *
	 * Add new admin bar item only on singular pages, to display a link that
	 * allows the user to edit with Elements PACMEC.
	 *
	...
	public function add_menu_in_admin_bar( \WP_Admin_Bar $wp_admin_bar ) {
		...
		$menu_args = [
			...
			'title' => __( 'Edit with Elements PACMEC', 'elementor' ),
		];
