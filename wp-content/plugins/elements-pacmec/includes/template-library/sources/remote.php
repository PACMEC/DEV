...
/**
 * Elements PACMEC template library remote source.
 *
 * Elements PACMEC template library remote source handler class is responsible for
 * handling remote templates from Elements PACMEC.com servers.
 *
 * @since 1.0.0
 */
class Source_Remote extends Source_Base {
	 ...
	 *
	 * Retrieve remote templates from Elements PACMEC servers.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 * Get remote template.
	 *
	 * Retrieve a single remote template from Elements PACMEC servers.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Remote template from Elements PACMEC servers cannot be saved on the
	 ...
	 *
	 * Remote template from Elements PACMEC servers cannot be updated on the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Remote template from Elements PACMEC servers cannot be deleted from the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Remote template from Elements PACMEC servers cannot be exported from the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Retrieve the data of a single remote template from Elements PACMEC servers.
	 *
	 * @since 1.5.0
	 * @access public
	 *
