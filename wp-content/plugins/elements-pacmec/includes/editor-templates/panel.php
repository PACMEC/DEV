...
<script type="text/template" id="tmpl-elementor-panel-schemes-disabled">
	...
	<div class="elementor-nerd-box-message"><?php printf( __( 'You can enable it from the <a href="%s" target="_blank">Elements PACMEC settings page</a>.', 'elementor' ), Settings::get_url() ); ?></div>
</script>
