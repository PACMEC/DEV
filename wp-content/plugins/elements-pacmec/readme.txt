=== Elements PACMEC Page Builder ===
Contributors: ClassicPress Research Team, Elements PACMEC Team
...
Elements PACMEC is a hard fork of Elementor and the terms of the GPL license.
...
To help you get started and learn just how to integrate with Elements PACMEC, we have created the [Official Elements PACMEC Developer Resources](https://developers.elementor.com/) and the [Code Reference](https://code.elementor.com/).
...
Sure can! Plugin widgets that appear in the WordPress widgets menu will also appear inside Elements PACMEC automatically. Just drag and drop them onto the page.
...
Yeah! Elements PACMEC enables to seamlessly build RTL pages as well as other translated pages in any language. You can read more about [translation and localization](https://go.elementor.com/translate/).
