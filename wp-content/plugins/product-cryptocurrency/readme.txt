...
> Binance Smart Chain (BSC), Polygon (Matic) and any other EVM-compatible blockchain is supported in the [PRO version](https://checkout.freemius.com/mode/dialog/plugin/4418/plan/7115/?trial=paid "The Cryptocurrency Product for WooCommerce Professional plugin")!
...
* Binance Smart Chain (BSC), Polygon (Matic) and any other EVM-compatible blockchain support
