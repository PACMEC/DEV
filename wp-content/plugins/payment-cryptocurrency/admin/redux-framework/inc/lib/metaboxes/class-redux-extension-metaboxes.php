...
if ( ! class_exists( 'Redux_Extension_Metaboxes', false ) ) {
	...
	class Redux_Extension_Metaboxes extends Redux_Extension_Abstract {
		 ...
		 * @return array
		 */
		public function add_box_classes( $classes ): array {
		 ...
		 * @return array
		 */
		public function override_can_output_css( $field ): array {
		 ...
		 * @return array
		 */
		public function output_css( $field ): array {
			if ( isset( $this->output[ $field['id'] ] ) ) {
		 ...
		 * @return array
		 */
		public function override_options( $options ): array {
...
*/
		 ...
		 * @return array
		 */
		public function add_box_hide_class( $classes ): array {
			$classes[] = 'hide';
