...
if ( ! class_exists( 'Redux_WordPress_Data', false ) ) {
	...
	class Redux_WordPress_Data extends Redux_Class {
		 ...
		 */
		public function get( $type, $args = array(), $opt_name = '', $current_value = '', $ajax = false ) {
		 ...
		 * @return array
		 */
		private function process_results( $results = array(), $id_key = '', $name_key = '', $add_key = true, $secondary_key = 'slug' ): array {
			$data = array();
		 ...
		 * @return array
		 */
		private function order_data( $data = array(), $sort = 'value', $order = 'asc' ): array {
			if ( 'key' === $sort ) {
				if ( 'asc' === $order ) {
					ksort( $data );
				} else {
		 ...
		 * @return array
		 */
		private function get_current_data_args( $type, $args, $current_value ): array {
