...
if ( ! class_exists( 'Redux', false ) ) {
	...
	class Redux {
		...
		public static function load() {
			...
			include_once Redux_Core::$dir . 'inc/extensions/metaboxes/class-redux-metaboxes-api.php';
		}
		 ...
		 * @return array
		 */
		public static function construct_sections( $opt_name ): array {
			$sections = array();
		 ...
		 * @deprecated No longer using camelCase naming convention.
		 */
		public static function setSection( $opt_name = '', ?array $section = array() ) {  // phpcs:ignore WordPress.NamingConventions.ValidFunctionName
			if ( '' !== $opt_name ) {
				Redux_Functions_Ex::record_caller( $opt_name );
			}
		 ...
		 */
		public static function set_section( $opt_name = '', ?array $section = array(), $replace = false ) {
		 ...
		 */
		private static function check_extension_class_file( $opt_name, $name = '', $class_file = '' ) {
			$instance = null;
