...
if ( ! class_exists( 'Redux_CDN', false ) ) {
	...
	class Redux_CDN {
		 ...
		 */
		public static function register_style( $handle, $src_cdn, $deps = array(), $ver = '', $media = 'all' ) {
		 ...
		 */
		public static function register_script( $handle, $src_cdn, $deps = array(), $ver = '', $in_footer = false ) {
			if ( empty( self::$parent ) || self::$parent->args['use_cdn'] ) {
		 ...
		 */
		public static function enqueue_style( $handle, $src_cdn, $deps = array(), $ver = '', $media = 'all' ) {
		 ...
		 * @param bool   $in_footer Script in footer.
		 */
		public static function enqueue_script( $handle, $src_cdn, $deps = array(), $ver = '', $in_footer = false ) {
			if ( self::$parent->args['use_cdn'] ) {
