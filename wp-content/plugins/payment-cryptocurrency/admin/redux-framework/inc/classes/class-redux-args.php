...
if ( ! class_exists( 'Redux_Args', false ) ) {
	...
	class Redux_Args {
		 ...
		 * @return array
		 */
		private function args( $args ): array {
		 ...
		 * @return array
		 */
		private function no_errors_please( $args ): array {
		 ...
		 * @return array
		 */
		private function shim( $args ): array {
			/**
			 * SHIM SECTION
		 ...
		 * @return array
		 */
		private function default_cleanup( $args ): array {
