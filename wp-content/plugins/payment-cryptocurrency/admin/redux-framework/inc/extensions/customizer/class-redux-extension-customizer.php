...
if ( ! class_exists( 'Redux_Extension_Customizer', false ) ) {
	...
	class Redux_Extension_Customizer extends Redux_Extension_Abstract {
		 ...
		 * @return array
		 */
		public function override_values( $data ): array {
			self::get_post_values();
		...
		public function register_customizer_controls( WP_Customize_Manager $wp_customize ) {
			if ( ! class_exists( 'Redux_Customizer_Section' ) ) {
				include_once dirname( __FILE__ ) . '/inc/class-redux-customizer-section.php';
				if ( method_exists( $wp_customize, 'register_section_type' ) ) {
					$wp_customize->register_section_type( 'Redux_Customizer_Section' );
				}
			}
			if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
				include_once dirname( __FILE__ ) . '/inc/class-redux-customizer-panel.php';
			...
			if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
				include_once dirname( __FILE__ ) . '/inc/class-redux-customizer-control.php';
			}

			include_once dirname( __FILE__ ) . '/inc/class-redux-customizer-fields.php';
			include_once dirname( __FILE__ ) . '/inc/class-redux-customizer-section-dev.php';
			include_once dirname( __FILE__ ) . '/inc/class-redux-customizer-control-dev.php';
		 ...
		 * @param WP_Customize_Manager $wp_customize .
		 */
		public function add_section( $id, $args, WP_Customize_Manager $wp_customize ) {
		 ...
		 * @access public
		 */
		public function add_panel( $id, $args, WP_Customize_Manager $wp_customize ) {
