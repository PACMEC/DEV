...
if ( ! class_exists( 'Redux_Metaboxes' ) ) {
	...
	class Redux_Metaboxes {
		 ...
		 * @deprecated 4.0.0 No more camelCase.
		 */
		public static function constructBoxes( $opt_name ): array {   // phpcs:ignore: WordPress.NamingConventions.ValidFunctionName
		 ...
		 * @return array
		 */
		public static function construct_boxes( $opt_name ): array {
			Redux_Functions_Ex::record_caller( $opt_name );
		 ...
		 * @deprecated 4.0.0 No more camelCase.
		 */
		public static function constructSections( $opt_name, $box_id ): array {   // phpcs:ignore: WordPress.NamingConventions.ValidFunctionName
		 ...
		 * @return array
		 */
		public static function construct_sections( $opt_name, $box_id ): array {
			Redux_Functions_Ex::record_caller( $opt_name );
		 ...
		 */
		public static function constructFields( $opt_name = '', $section_id = '' ): array {   // phpcs:ignore: WordPress.NamingConventions.ValidFunctionName
		 ...
		 * @return array
		 */
		public static function construct_fields( $opt_name = '', $section_id = '' ): array {
			Redux_Functions_Ex::record_caller( $opt_name );
