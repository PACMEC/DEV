...
if ( ! class_exists( 'Redux_Core', false ) ) {
	...
	class Redux_Core {
		...
		private function init() {
         ...
         // phpcs:enable
			...
			if ( ! class_exists( 'ReduxAppsero\Client' ) ) {
				include_once Redux_Path::get_path( '/appsero/Client.php' );
			}
		...
		private function includes() {
			...
			include_once dirname( __FILE__ ) . '/inc/classes/class-redux-enable-gutenberg.php';
		 ...
		 * @return array
		 */
		public function add_debug_info( $debug_info ): array {
		...
		public function register_classes( $class_name ) {
			...
			if ( ! class_exists( $class_name ) ) {
				...
				if ( 'Redux_Welcome' === $class_name ) {
					include_once Redux_Path::get_path( '/inc/welcome/class-redux-welcome.php' );
