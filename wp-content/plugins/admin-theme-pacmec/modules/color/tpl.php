<h3 class="m-b"><span><?php esc_html_e('Colors', 'pacmec_admin_theme'); ?></span></h3>
<p class="no-m-t text-sm">
	<label>
		...
		<?php esc_html_e('Use default color', 'pacmec_admin_theme'); ?>
	</label>
</p>
<div class="box">
	<h4 class="active"><span><?php esc_html_e('Default colors', 'pacmec_admin_theme'); ?></span></h4>
...
<div class="box">
	<h4 class="b-b"><span><?php esc_html_e('Global', 'pacmec_admin_theme'); ?></span></h4>
	<div class="box-body b-b hide">
		<div class="color-picker">
			<p>
				<label><?php esc_html_e('Base color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Icon color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Highlight color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Notification color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Body background', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Link color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Form checked', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Button color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Secondary button color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Secondary button text', 'pacmec_admin_theme'); ?></label>
	...
	<h4 class="b-b active"><span><?php esc_html_e('Menu', 'pacmec_admin_theme'); ?></span></h4>
	<div class="box-body b-b hide">
		<div class="color-picker">
			<p>
				<label><?php esc_html_e('Menu text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Menu icon color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Menu background', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Menu highlight text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Menu highlight icon color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Menu highlight background', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Menu current text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Menu current icon color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Menu current background', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Submenu text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Submenu focus text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Submenu current text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Submenu background', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Bubble text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Bubble background', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Bubble current text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Bubble current background', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Collapse text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Collapse icon color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Collapse focus text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Collapse focus icon color', 'pacmec_admin_theme'); ?></label>
	...
	<h4><span><?php esc_html_e('Bar', 'pacmec_admin_theme'); ?></span></h4>
	<div class="box-body b-t hide">
		<div class="color-picker">
			<p>
				<label><?php esc_html_e('Bar text color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Bar icon color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Bar highlight icon color', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Bar background', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Bar submemu text', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Bar submemu focus text', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Bar submenu background', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Avatar frame', 'pacmec_admin_theme'); ?></label>
			...
			<p>
				<label><?php esc_html_e('Input background', 'pacmec_admin_theme'); ?></label>
