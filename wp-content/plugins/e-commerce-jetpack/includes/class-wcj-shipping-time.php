...
class WCJ_Shipping_Time extends WCJ_Module {
	...
	function __construct() {
		...
		$this->short_desc = __( 'Shipping Time', 'e-commerce-jetpack' );
		$this->extra_desc = sprintf( __( 'After you set estimated shipping time here, you can display it on frontend with %s shortcodes.', 'e-commerce-jetpack' ),
			'<code>[wcj_shipping_time_table]</code>, <code>[wcj_product_shipping_time_table]</code>' );
		$this->desc       = __( 'Add delivery time estimation to shipping methods.', 'e-commerce-jetpack' );
