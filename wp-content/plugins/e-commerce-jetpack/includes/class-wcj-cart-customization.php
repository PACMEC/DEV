...
class WCJ_Cart_Customization extends WCJ_Module {
	...
	function __construct() {
		...
		$this->short_desc = __( 'Cart Customization', 'e-commerce-jetpack' );
		$this->desc       = __( 'Customize WooCommerce cart - hide coupon field; item remove link; change empty cart "Return to shop" button text.', 'e-commerce-jetpack' );
