...
class WCJ_Payment_Gateways_Icons extends WCJ_Module {
	...
	function __construct() {
		...
		$this->short_desc = __( 'Gateways Icons', 'e-commerce-jetpack' );
		$this->desc       = __( 'Change or completely remove icons (images) for any (default or custom) payment gateway.', 'e-commerce-jetpack' );
