...
class WCJ_Product_Listings extends WCJ_Module {
	...
	function __construct() {
		...
		$this->short_desc = __( 'Product Listings', 'e-commerce-jetpack' );
		$this->desc       = __( 'Change display options for shop and category pages: show/hide categories count (Hide subcategories count on category pages allowed in Plus), exclude categories, show/hide empty categories.', 'e-commerce-jetpack' );
		$this->desc_pro   = __( 'Change display options for shop and category pages: show/hide categories count, exclude categories, show/hide empty categories.', 'e-commerce-jetpack' );
