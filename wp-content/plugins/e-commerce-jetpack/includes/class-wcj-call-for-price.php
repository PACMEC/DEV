...
class WCJ_Call_For_Price extends WCJ_module {
	...
	function __construct() {
		...
		$this->short_desc = __( 'Call for Price', 'e-commerce-jetpack' );
		$this->desc       = __( 'Create any custom price label for all products with empty price (Plus).', 'e-commerce-jetpack' );
		$this->desc_pro   = __( 'Create any custom price label for all products with empty price.', 'e-commerce-jetpack' );
