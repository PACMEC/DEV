...
foreach ( $invoice_types as $invoice_type ) {
	...
	$settings = array_merge( $settings, array(
		...
		array(
			'title'    => __( 'Admin\'s "Orders" Page', 'e-commerce-jetpack' ),
			'desc'     => __( 'Add Column', 'e-commerce-jetpack' ),
		...
		array(
			'title'    => '',
			'desc'     => __( 'Column Title', 'e-commerce-jetpack' ),
		...
		array(
			'desc'     => __( 'Add "View" button', 'e-commerce-jetpack' ),
		...
		array(
			'desc'     => __( 'Add "Create" button', 'e-commerce-jetpack' ),
		...
		array(
			'desc'     => __( '"Create" button requires confirmation', 'e-commerce-jetpack' ),
		...
		array(
			'desc'     => __( '"Delete" button requires confirmation', 'e-commerce-jetpack' ),
		...
		array(
			'title'    => __( 'Thank You Page', 'e-commerce-jetpack' ),
			'desc'     => __( 'Add link', 'e-commerce-jetpack' ),
			'id'       => 'wcj_invoicing_' . $invoice_type['id'] . '_enabled_on_thankyou_page',
			'default'  => 'no',
			'type'     => 'checkbox',
		),
		array(
			'desc'     => __( 'Link Text', 'e-commerce-jetpack' ),
		...
		array(
			'desc'     => __( 'HTML Template', 'e-commerce-jetpack' ) . '. ' . wcj_message_replaced_values( array( '%link%' ) ),
			'id'       => 'wcj_invoicing_' . $invoice_type['id'] . '_thankyou_page_template',
			'default'  => '<p><strong>' . sprintf( __( 'Your %s:', 'e-commerce-jetpack' ), $invoice_type['title'] ) . ' </strong> %link%</p>',
			'type'     => 'custom_textarea',
			'class'    => 'widefat',
		),
		array(
			'title'    => __( 'Customer\'s "My Account" Page', 'e-commerce-jetpack' ),
			'desc'     => __( 'Add link', 'e-commerce-jetpack' ),
		...
		array(
			'title'    => __( 'Enable "Save as"', 'e-commerce-jetpack' ),
			'desc'     => __( 'Enable', 'e-commerce-jetpack' ),
			'desc_tip' => __( 'Enable "save as" pdf instead of view pdf in browser', 'e-commerce-jetpack' ),
			'id'       => 'wcj_invoicing_' . $invoice_type['id'] . '_save_as_enabled',
			'default'  => 'no',
			'type'     => 'checkbox',
		),
		array(
			'title'    => __( 'PDF File Name', 'e-commerce-jetpack' ),
			'desc'     => sprintf( __( 'Enter file name for PDF documents. You can use shortcodes here, e.g. %s.', 'e-commerce-jetpack' ),
		...
		array(
			'title'    => __( 'Allowed User Roles', 'e-commerce-jetpack' ),
			'desc'     => __( 'If set to empty - Administrator role will be used.', 'e-commerce-jetpack' ),
