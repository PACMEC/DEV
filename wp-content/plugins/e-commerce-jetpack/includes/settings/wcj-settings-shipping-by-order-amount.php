...
$settings = array(
	...
	array(
		'title'   => __( 'Shipping Methods by Min/Max Order Amount', 'e-commerce-jetpack' ),
		'type'    => 'title',
		'desc'    => __( 'Set to zero to disable. Allows only non-decimal value.', 'e-commerce-jetpack' ),
...
foreach ( $shipping_methods as $method ) {
	...
	$settings = array_merge( $settings, array(
		array(
			...
			'desc_tip'  => $desc_tip,
			'desc'      => '<br>' . __( 'Minimum order amount', 'e-commerce-jetpack' ),
		...
		array(
			'desc_tip'  => $desc_tip,
			'desc'      => '<br>' . __( 'Maximum order amount', 'e-commerce-jetpack' ),
