	...
	for ( $i = 1; $i <= $total_number; $i++ ) {
		...
		$currencies = array_merge( $currencies, array(
			array(
				...
				'default'    => '',
				'type'       => 'price',
				'title'      => '[' . $currency_code . '] ' . __( 'Regular Price', 'e-commerce-jetpack' ),
				'desc'       => $desc,
			...
			array(
				...
				'default'    => '',
				'type'       => 'price',
				'title'      => '[' . $currency_code . '] ' . __( 'Sale Price', 'e-commerce-jetpack' ),
				'desc'       => $desc,
				'product_id' => $product_id,
		...
		if ( 'yes' === wcj_get_option( 'wcj_multicurrency_per_product_make_empty', 'no' ) ) {
			$currencies[] = array(
				...
				'title'      => '[' . $currency_code . '] ' . __( 'Make Empty Price', 'e-commerce-jetpack' ),
				'desc'       => $desc,
				'product_id' => $product_id,
