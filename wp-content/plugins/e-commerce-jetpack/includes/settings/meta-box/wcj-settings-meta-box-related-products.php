...
$options = array(
	array(
		...
		'tooltip'  => __( 'If enabled and no products selected - will hide related products section on frontend for current product.', 'e-commerce-jetpack' ),
	...
	array(
		'title'    => __( 'Related Products', 'e-commerce-jetpack' ),
		'tooltip'  => ( $is_chosen_select ? ''              : __( 'Hold Control (Ctrl) key to select multiple products. Ctrl and "A" to select all products.', 'e-commerce-jetpack' ) ),
