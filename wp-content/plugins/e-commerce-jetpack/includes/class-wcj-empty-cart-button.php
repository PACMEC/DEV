...
class WCJ_Empty_Cart_Button extends WCJ_Module {
	...
	function __construct() {
		...
		$this->id         = 'empty_cart';
		$this->short_desc = __( 'Empty Cart Button', 'e-commerce-jetpack' );
		$this->desc       = __( 'Add (and customize) "Empty Cart" button to the cart and checkout pages. Customize empty cart button text (Plus). Different button positions on the cart page (Plus).', 'e-commerce-jetpack' );
		$this->desc_pro   = __( 'Add (and customize) "Empty Cart" button to the cart and checkout pages.', 'e-commerce-jetpack' );
