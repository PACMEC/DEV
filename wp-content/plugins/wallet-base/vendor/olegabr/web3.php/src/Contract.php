...
class Contract
{
    ...
    public function __construct($provider, $abi, $defaultBlock = 'latest')
    {
        ...
        $this->ethabi = new Ethabi(['address' => new Address(), 'bool' => new Boolean(), 'bytes' => new Bytes(), 'dynamicBytes' => new DynamicBytes(), 'int' => new Integer(), 'string' => new Str(), 'uint' => new Uinteger()]);
    }
    /**
     * call
     *
