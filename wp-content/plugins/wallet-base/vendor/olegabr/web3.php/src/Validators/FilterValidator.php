...
class FilterValidator
{
    ...
    public static function validate($value)
    {
        ...
        if (isset($value['fromBlock']) && QuantityValidator::validate($value['fromBlock']) === \false && TagValidator::validate($value['fromBlock']) === \false) {
            return \false;
        }
        if (isset($value['toBlock']) && QuantityValidator::validate($value['toBlock']) === \false && TagValidator::validate($value['toBlock']) === \false) {
            return \false;
        }
