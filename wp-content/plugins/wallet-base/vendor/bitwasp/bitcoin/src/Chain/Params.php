...
class Params implements ParamsInterface
{
    ...
    {
        return new BlockHeader(1, Buffer::hex('00', 32), Buffer::hex('4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b', 32), 1231006505, 0x1d00ffff, 2083236893);
    }
    /**
    ...
    public function getGenesisBlock() : BlockInterface
    {
        ...
        $inputScript = ScriptFactory::create()->push(Buffer::int('486604799', 4)->flip())->push(Buffer::int('4', 1))->push($timestamp)->getScript();
        return new Block($this->math, $this->getGenesisBlockHeader(), (new TxBuilder())->version(1)->input(new Buffer('', 32), 0xffffffff, $inputScript)->output(5000000000, ScriptFactory::sequence([$publicKey, Opcodes::OP_CHECKSIG]))->locktime(0)->get());
    }
    /**
     * @return int
     */
