...
class Checksig
{
    ...
    public function getSolution()
    {
        if ($this->info instanceof Multisig) {
            ...
            if ($this->info instanceof PayToPubkey) {
     ...
     */
    public function serialize(TransactionSignatureSerializer $txSigSerializer, PublicKeySerializerInterface $pubKeySerializer) : array
    {
        ...
        if (ScriptType::P2PK === $outputType) {
            ...
            if (ScriptType::P2PKH === $outputType) {
                ...
                if (ScriptType::MULTISIG === $outputType) {
                    if (!$this->required) {
