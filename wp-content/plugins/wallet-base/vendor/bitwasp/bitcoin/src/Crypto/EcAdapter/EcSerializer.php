...
class EcSerializer
{
     ...
     * @var string[]
     */
    private static $serializerInterface = [PrivateKeySerializerInterface::class, PublicKeySerializerInterface::class, CompactSignatureSerializerInterface::class, DerSignatureSerializerInterface::class];
    /**
     * @var string[]
     */
     ...
     * @return mixed
     */
    public static function getSerializer(string $interface, $useCache = \true, EcAdapterInterface $adapter = null)
    {
        if (null === $adapter) {
