...
class PublicKey extends Key implements PublicKeyInterface, \Ethereumico\EthereumWallet\Dependencies\Mdanter\Ecc\Crypto\Key\PublicKeyInterface
{
    /**
     * @var EcAdapter
     */
     ...
     * @param string $prefix
     */
    public function __construct(EcAdapter $ecAdapter, PointInterface $point, bool $compressed = \false, string $prefix = null)
    {
