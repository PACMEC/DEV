...
class FullyQualifiedScript
{
    ...
    public function __construct(OutputData $spkData, OutputData $rsData = null, OutputData $wsData = null)
    {
        ...
        if ($signScript->getType() === ScriptType::P2WKH) {
            ...
            if ($signScript->getType() === ScriptType::P2WSH) {
     ...
     */
    public static function fromTxData(ScriptInterface $scriptPubKey, ScriptInterface $scriptSig, ScriptWitnessInterface $witness, SignData $signData = null, OutputClassifier $classifier = null)
    {
