...
class GlobalPrefixConfig
{
    ...
    public function __construct(array $config)
    {
        foreach ($config as $networkPrefixConfig) {
            if (!$networkPrefixConfig instanceof \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Key\Deterministic\HdPrefix\NetworkConfig) {
     ...
     */
    public function getNetworkConfig(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Network\NetworkInterface $network) : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Key\Deterministic\HdPrefix\NetworkConfig
    {
