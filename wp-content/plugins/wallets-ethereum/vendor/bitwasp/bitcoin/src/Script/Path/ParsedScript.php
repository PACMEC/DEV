...
class ParsedScript
{
     ...
     */
    public function __construct(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\ScriptInterface $script, \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Path\LogicOpNode $ast, array $branches)
    {
        if (!$ast->isRoot()) {
    ...
    {
        return \array_map(function (\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Path\ScriptBranch $branch) {
