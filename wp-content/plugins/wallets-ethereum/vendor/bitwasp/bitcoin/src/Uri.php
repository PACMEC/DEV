...
class Uri
{
     ...
     */
    public function __construct(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Address\AddressInterface $address = null, int $convention = self::BIP0021)
    {
     ...
     * @return $this
     */
    public function setAmount(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Amount $amount, int $value)
    {
     ...
     * @return string
     */
    public function uri(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Network\NetworkInterface $network = null) : string
    {
