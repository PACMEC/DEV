...
class CheckSequenceVerify
{
    ...
    public function __construct(int $relativeTimeLock)
    {
        ...
        if ($relativeTimeLock > \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Locktime::INT_MAX) {
     ...
     * @return static
     */
    public static function fromDecodedScript(array $chunks, $fMinimal = \false) : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Transaction\Factory\ScriptInfo\CheckSequenceVerify
    {
        if (\count($chunks) !== 3) {
        ...
        if ($chunks[1]->getOp() !== \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Opcodes::OP_CHECKSEQUENCEVERIFY) {
        ...
        return new \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Transaction\Factory\ScriptInfo\CheckSequenceVerify($numLockTime->getInt());
    }
    /**
    ...
    public function isRelativeToBlock() : bool
    {
        ...
        return ($this->relativeTimeLock & \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Transaction\TransactionInput::SEQUENCE_LOCKTIME_TYPE_FLAG) === 0;
    }
    /**
     * @return bool
     */
    ...
    {
        return ($this->relativeTimeLock & \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Transaction\TransactionInput::SEQUENCE_LOCKTIME_DISABLE_FLAG) != 0;
    }
}
