...
class TxMutator
{
     ...
     */
    public function inputsMutator() : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Transaction\Mutator\InputCollectionMutator
    {
        if (null === $this->inputsMutator) {
            $this->inputsMutator = new \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Transaction\Mutator\InputCollectionMutator($this->transaction->getInputs());
        }
     ...
     */
    public function outputsMutator() : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Transaction\Mutator\OutputCollectionMutator
    {
        if (null === $this->outputsMutator) {
            $this->outputsMutator = new \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Transaction\Mutator\OutputCollectionMutator($this->transaction->getOutputs());
        }
     ...
     */
    public function done() : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Transaction\TransactionInterface
    {
        if (null !== $this->inputsMutator) {
