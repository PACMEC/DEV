...
class Buffer implements \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface
{
    /**
     * @var int
     */
    ...
    {
        return ['size' => $this->size, 'buffer' => '0x' . \unpack("H*", $this->buffer)[1]];
    }
    /**
     ...
     * @throws \Exception
     */
    public static function hex(string $hexString = '', int $byteSize = null) : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface
    {
     ...
     * @return Buffer
     */
    public static function int($integer, $byteSize = null) : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface
    {
     ...
     * @throws \Exception
     */
    public static function gmp(\GMP $gmp, $byteSize = null) : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface
    {
        if (\gmp_sign($gmp) < 0) {
    ...
    {
        /** @var Buffer $buffer */
        $buffer = \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\Buffertools::flipBytes($this);
        return $buffer;
    }
    /**
