 ...
 */
namespace Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint;

/**
 * Defines a constraint.
 */
class Constraint implements \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matches(\Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\ConstraintInterface $provider)
    {
     ...
     * @return bool
     */
    public function matchSpecific(\Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
    ...
    private function extractBounds()
    {
        ...
        // Branches
        if (\strpos($this->version, 'dev-') === 0) {
            $this->lowerBound = \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound::zero();
            $this->upperBound = \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound::positiveInfinity();
            return;
        }
        switch ($this->operator) {
            case self::OP_EQ:
                $this->lowerBound = new \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound($this->version, \true);
                $this->upperBound = new \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound($this->version, \true);
                break;
            case self::OP_LT:
                $this->lowerBound = \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound::zero();
                $this->upperBound = new \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound($this->version, \false);
                break;
            case self::OP_LE:
                $this->lowerBound = \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound::zero();
                $this->upperBound = new \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound($this->version, \true);
                break;
            case self::OP_GT:
                $this->lowerBound = new \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound($this->version, \false);
                $this->upperBound = \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound::positiveInfinity();
                break;
            case self::OP_GE:
                $this->lowerBound = new \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound($this->version, \true);
