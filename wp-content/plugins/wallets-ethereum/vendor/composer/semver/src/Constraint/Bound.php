...
class Bound
{
     ...
     * @return bool
     */
    public function compareTo(\Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound $other, $operator)
    {
    ...
    {
        return new \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound('0.0.0.0-dev', \true);
    }
    /**
     * @return self
     */
    ...
    {
        return new \Ethereumico\EthereumWallet\Dependencies\Composer\Semver\Constraint\Bound(\PHP_INT_MAX . '.0.0.0', \false);
    }
}
