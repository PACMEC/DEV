 ...
 */
class TransactionLegacy implements \ArrayAccess
{
    /**
     ...
     * @var array
     */
    protected $attributeMap = ['from' => ['key' => -1], 'chainId' => ['key' => -2], 'nonce' => ['key' => 0, 'length' => 32, 'allowLess' => \true, 'allowZero' => \false], 'gasPrice' => ['key' => 1, 'length' => 32, 'allowLess' => \true, 'allowZero' => \false], 'gasLimit' => ['key' => 2, 'length' => 32, 'allowLess' => \true, 'allowZero' => \false], 'gas' => ['key' => 2, 'length' => 32, 'allowLess' => \true, 'allowZero' => \false], 'to' => ['key' => 3, 'length' => 20, 'allowZero' => \true], 'value' => ['key' => 4, 'length' => 32, 'allowLess' => \true, 'allowZero' => \false], 'data' => ['key' => 5, 'allowLess' => \true, 'allowZero' => \true], 'v' => ['key' => 6, 'allowZero' => \true], 'r' => ['key' => 7, 'length' => 32, 'allowZero' => \true], 's' => ['key' => 8, 'length' => 32, 'allowZero' => \true]];
    /**
    ...
    {
        $this->rlp = new \Ethereumico\EthereumWallet\Dependencies\Web3p\RLP\RLP();
        $this->secp256k1 = new \Ethereumico\EthereumWallet\Dependencies\Elliptic\EC('secp256k1');
        $this->util = new \Ethereumico\EthereumWallet\Dependencies\Web3p\EthereumUtil\Util();
        if (\is_array($txData)) {
    ...
    public function sign($privateKey)
    {
        ...
        $signature = $ecPrivateKey->sign($txHash, ['canonical' => \true]);
        $r = $signature->r;
        $s = $signature->s;
    ...
    public function getFromAddress()
    {
        ...
        if (!isset($this->privateKey) || !$this->privateKey instanceof \Ethereumico\EthereumWallet\Dependencies\Elliptic\EC\KeyPair) {
            // recover from hash
            $r = $this->offsetGet('r');
            $s = $this->offsetGet('s');
            $v = $this->offsetGet('v');
            ...
            $v -= 35;
            $publicKey = $this->secp256k1->recoverPubKey($txHash, ['r' => $r, 's' => $s], $v);
