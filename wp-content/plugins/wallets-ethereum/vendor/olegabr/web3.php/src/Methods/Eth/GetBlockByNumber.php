...
class GetBlockByNumber extends \Ethereumico\EthereumWallet\Dependencies\Web3\Methods\EthMethod
{
    /**
     * validators
     * 
     * @var array
     */
    protected $validators = [[\Ethereumico\EthereumWallet\Dependencies\Web3\Validators\QuantityValidator::class, \Ethereumico\EthereumWallet\Dependencies\Web3\Validators\TagValidator::class], \Ethereumico\EthereumWallet\Dependencies\Web3\Validators\BooleanValidator::class];
    /**
     * inputFormatters
     * 
     * @var array
     */
    protected $inputFormatters = [\Ethereumico\EthereumWallet\Dependencies\Web3\Formatters\OptionalQuantityFormatter::class, \Ethereumico\EthereumWallet\Dependencies\Web3\Formatters\BooleanFormatter::class];
    /**
     * outputFormatters
     * 
     * @var array
