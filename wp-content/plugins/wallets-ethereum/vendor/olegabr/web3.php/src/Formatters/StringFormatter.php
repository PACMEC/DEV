...
class StringFormatter implements \Ethereumico\EthereumWallet\Dependencies\Web3\Formatters\IFormatter
{
    /**
     * format
     * 
    ...
    {
        return \Ethereumico\EthereumWallet\Dependencies\Web3\Utils::toString($value);
    }
}
