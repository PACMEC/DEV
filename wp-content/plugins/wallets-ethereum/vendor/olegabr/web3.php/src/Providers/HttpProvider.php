 ...
 * @license MIT
 */
namespace Ethereumico\EthereumWallet\Dependencies\Web3\Providers;

use Ethereumico\EthereumWallet\Dependencies\Web3\Providers\Provider;
use Ethereumico\EthereumWallet\Dependencies\Web3\Providers\IProvider;
use Ethereumico\EthereumWallet\Dependencies\Web3\RequestManagers\RequestManager;
class HttpProvider extends \Ethereumico\EthereumWallet\Dependencies\Web3\Providers\Provider implements \Ethereumico\EthereumWallet\Dependencies\Web3\Providers\IProvider
{
    /**
     * methods
     * 
     ...
     * @return void
     */
    public function __construct(\Ethereumico\EthereumWallet\Dependencies\Web3\RequestManagers\RequestManager $requestManager)
    {
