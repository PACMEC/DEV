...
class TransactionValidator
{
    ...
    public static function validate($value)
    {
        ...
        if (\Ethereumico\EthereumWallet\Dependencies\Web3\Validators\AddressValidator::validate($value['from']) === \false) {
            return \false;
        }
        if (isset($value['to']) && \Ethereumico\EthereumWallet\Dependencies\Web3\Validators\AddressValidator::validate($value['to']) === \false && $value['to'] !== '') {
            return \false;
        }
