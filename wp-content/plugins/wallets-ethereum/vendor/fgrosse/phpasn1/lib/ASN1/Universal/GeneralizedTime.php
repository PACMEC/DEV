...
use Ethereumico\EthereumWallet\Dependencies\FG\ASN1\AbstractTime;
 ...
 */
class GeneralizedTime extends \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\AbstractTime implements \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Parsable
{
    ...
    {
        return \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Identifier::GENERALIZED_TIME;
    }
    ...
    {
        self::parseIdentifier($binaryData[$offsetIndex], \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Identifier::GENERALIZED_TIME, $offsetIndex++);
        ...
        if ($contentLength == $lengthOfMinimumTimeString) {
            ...
            if ($maximumBytesToRead > 0) {
                if ($binaryData[$offsetIndex] == '+' || $binaryData[$offsetIndex] == '-') {
                    ...
                    throw new \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Exception\ParserException('Invalid ISO 8601 Time String', $offsetIndex);
                }
            }
        }
