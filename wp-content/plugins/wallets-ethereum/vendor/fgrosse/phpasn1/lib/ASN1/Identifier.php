...
class Identifier
{
    ...
    public static function create($class, $isConstructed, $tagNumber)
    {
        ...
        return \chr($firstOctet) . \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Base128::encode($tagNumber);
    }
    ...
    public static function getTagNumber($identifier)
    {
        ...
        return \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Base128::decode(\substr($identifier, 1));
    }
