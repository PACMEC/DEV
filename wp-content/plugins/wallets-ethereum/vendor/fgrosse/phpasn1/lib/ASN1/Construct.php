...
use Iterator;
abstract class Construct extends \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\ASNObject implements \Countable, \ArrayAccess, \Iterator, \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Parsable
{
    ...
    public function addChild(\Ethereumico\EthereumWallet\Dependencies\FG\ASN1\ASNObject $child)
    {
        $this->children[] = $child;
    }
    ...
    public static function fromBinary(&$binaryData, &$offsetIndex = 0)
    {
        ...
        while ($octetsToRead > 0) {
            $newChild = \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\ASNObject::fromBinary($binaryData, $offsetIndex);
            $octetsToRead -= $newChild->getObjectLength();
            $children[] = $newChild;
        }
        if ($octetsToRead !== 0) {
            throw new \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Exception\ParserException("Sequence length incorrect", $startIndex);
        }
