...
namespace Ethereumico\EthereumWallet\Dependencies\Elliptic\Curve\MontCurve;
...
class Point extends \Ethereumico\EthereumWallet\Dependencies\Elliptic\Curve\BaseCurve\Point
{
    ...
    {
        return new \Ethereumico\EthereumWallet\Dependencies\Elliptic\Curve\MontCurve\Point($curve, $obj[0], isset($obj[1]) ? $obj[1] : $curve->one);
    }
