...
class JPoint extends \Ethereumico\EthereumWallet\Dependencies\Elliptic\Curve\BaseCurve\Point
{
    public $x;
    public $y;
    public $z;
    ...
    function __construct($curve, $x, $y, $z)
    {
        ...
        if ($x == null && $y == null && $z == null) {
            ...
            $this->z = new \Ethereumico\EthereumWallet\Dependencies\BN\BN(0);
        } else {
            ...
            $this->z = new \Ethereumico\EthereumWallet\Dependencies\BN\BN($z, 16);
        }
        if (!$this->x->red) {
    ...
    {
        return $this->curve->_wnafMul($this, new \Ethereumico\EthereumWallet\Dependencies\BN\BN($k, $kbase));
    }
