...
{
    const MAP = [
        'type' => \Ethereumico\EthereumWallet\Dependencies\phpseclib3\File\ASN1::TYPE_SET,
        'min' => 1,
        'max' => 256,
        // ub-extension-attributes
        'children' => \Ethereumico\EthereumWallet\Dependencies\phpseclib3\File\ASN1\Maps\ExtensionAttribute::MAP,
    ];
}
