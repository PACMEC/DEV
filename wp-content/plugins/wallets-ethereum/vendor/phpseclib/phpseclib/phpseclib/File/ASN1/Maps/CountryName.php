...
abstract class CountryName
{
    const MAP = [
        ...
        'cast' => 1,
        'children' => ['x121-dcc-code' => ['type' => \Ethereumico\EthereumWallet\Dependencies\phpseclib3\File\ASN1::TYPE_NUMERIC_STRING], 'iso-3166-alpha2-code' => ['type' => \Ethereumico\EthereumWallet\Dependencies\phpseclib3\File\ASN1::TYPE_PRINTABLE_STRING]],
    ];
}
