 ...
 */
namespace Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\DSA;

use Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\DSA;
use Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\DSA\Formats\Signature\ASN1 as ASN1Signature;
 ...
 * @access  public
 */
class PrivateKey extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\DSA implements \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\Common\PrivateKey
{
    ...
    public function getPublicKey()
    {
        ...
        return \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\DSA::loadFormat('PKCS8', $key)->withHash($this->hash->getHash())->withSignatureFormat($this->shortFormat);
    }
    /**
     * Create a signature
     *
    ...
    public function sign($message)
    {
        ...
        if (self::$engines['OpenSSL'] && \in_array($this->hash->getHash(), \openssl_get_md_methods())) {
            ...
            if ($result) {
                ...
                \extract(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\DSA\Formats\Signature\ASN1::load($signature));
        ...
        $h = $this->bits2int($h);
        while (\true) {
            $k = \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger::randomRange(self::$one, $this->q->subtract(self::$one));
