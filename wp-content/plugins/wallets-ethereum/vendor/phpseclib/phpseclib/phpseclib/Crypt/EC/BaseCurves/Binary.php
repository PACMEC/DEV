...
use Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BinaryField\Integer as BinaryInteger;
/**
 * Curves over y^2 + x*y = x^3 + a*x^2 + b
 *
 * @package Binary
 ...
 * @access  public
 */
class Binary extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\EC\BaseCurves\Base
{
    /**
    ...
    {
        $this->modulo = $modulo;
        $this->factory = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BinaryField(...$modulo);
    ...
    {
        switch (\true) {
            case !\is_string($x) && !$x instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BinaryField\Integer:
            ...
            case !\is_string($y) && !$y instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BinaryField\Integer:
