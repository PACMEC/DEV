...
abstract class Base
{
     ...
     * @return object
     */
    public function convertInteger(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $x)
    {
    ...
    public function createRandomMultiplier()
    {
        ...
        return \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger::randomRange($one, $this->order->subtract($one));
    }
    /**
     ...
     * Sets the Order
     */
    public function setOrder(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $order)
    {
        $this->order = $order;
    }
    /**
