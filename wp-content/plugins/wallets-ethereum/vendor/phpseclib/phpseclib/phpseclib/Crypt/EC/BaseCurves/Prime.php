 ...
 */
namespace Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\EC\BaseCurves;

use Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\Common\FiniteField\Integer;
...
use Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @package Prime
 ...
 * @access  public
 */
class Prime extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\EC\BaseCurves\Base
{
    /**
     ...
     * Sets the modulo
     */
    public function setModulo(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $modulo)
    {
        $this->modulo = $modulo;
        $this->factory = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\PrimeField($modulo);
        $this->two = $this->factory->newInteger(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(2));
        $this->three = $this->factory->newInteger(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(3));
        // used by jacobian coordinates
        $this->one = $this->factory->newInteger(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(1));
        $this->four = $this->factory->newInteger(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(4));
        $this->eight = $this->factory->newInteger(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(8));
    }
    /**
     * Set coefficients a and b
     */
    public function setCoefficients(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $a, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $b)
    {
    ...
    {
        switch (\true) {
            case !$x instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger && !$x instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\PrimeField\Integer:
            ...
            case !$y instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger && !$y instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\PrimeField\Integer:
        ...
        $this->p = [$x instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger ? $this->factory->newInteger($x) : $x, $y instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger ? $this->factory->newInteger($y) : $y];
    }
    /**
    ...
    {
        $y = \ord(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Common\Functions\Strings::shift($m));
        $x = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger($m, 256);
     ...
     * @return int[]
     */
    private static function getJSFPoints(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\Common\FiniteField\Integer $k1, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\Common\FiniteField\Integer $k2)
    {
        static $three;
        if (!isset($three)) {
            $three = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(3);
        }
        $jsf = [[], []];
        $k1 = $k1->toBigInteger();
        $k2 = $k2->toBigInteger();
        $d1 = 0;
        $d2 = 0;
        while ($k1->compare(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(-$d1)) > 0 || $k2->compare(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(-$d2)) > 0) {
            // first phase
