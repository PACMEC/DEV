 ...
 */
namespace Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath\Reductions;

use Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath\Base;
 ...
 * @access  public
 */
abstract class EvalBarrett extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath\Base
{
    /**
     ...
     */
    protected static function generateCustomReduction(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath $m, $class)
    {
        $m_length = \strlen($m);
        if ($m_length < 5) {
