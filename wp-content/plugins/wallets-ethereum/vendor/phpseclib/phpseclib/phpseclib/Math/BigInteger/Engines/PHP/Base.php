 ...
 * @access  public
 */
abstract class Base extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP
{
    /**
     * Cache constants
     *
     ...
     */
    protected static function powModHelper(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $x, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $e, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $n, $class)
    {
        if (empty($e->value)) {
            $temp = new $class();
            $temp->value = [1];
