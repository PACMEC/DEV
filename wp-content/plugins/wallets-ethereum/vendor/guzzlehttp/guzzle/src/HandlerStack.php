...
class HandlerStack
{
    ...
    {
        $stack = new self($handler ?: \Ethereumico\EthereumWallet\Dependencies\GuzzleHttp\Utils::chooseHandler());
        $stack->push(\Ethereumico\EthereumWallet\Dependencies\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\Ethereumico\EthereumWallet\Dependencies\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\Ethereumico\EthereumWallet\Dependencies\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\Ethereumico\EthereumWallet\Dependencies\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
     ...
     */
    public function __invoke(\Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\RequestInterface $request, array $options)
    {
