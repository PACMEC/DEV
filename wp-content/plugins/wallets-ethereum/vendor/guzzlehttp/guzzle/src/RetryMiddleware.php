...
class RetryMiddleware
{
     ...
     */
    private function onFulfilled(\Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\RequestInterface $request, array $options) : callable
    {
     ...
     */
    private function onRejected(\Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\RequestInterface $req, array $options) : callable
    {
    ...
    private function doRetry(\Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\RequestInterface $request, array $options, \Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\ResponseInterface $response = null) : \Ethereumico\EthereumWallet\Dependencies\GuzzleHttp\Promise\PromiseInterface
    {
