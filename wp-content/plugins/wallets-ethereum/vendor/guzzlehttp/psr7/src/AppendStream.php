 ...
 */
final class AppendStream implements \Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\StreamInterface $stream) : void
    {
    ...
    {
        return \Ethereumico\EthereumWallet\Dependencies\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
