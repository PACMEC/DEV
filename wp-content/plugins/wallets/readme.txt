...
1. The `[ethereum-wallet-account]` display
...
9. The `[ethereum-wallet-nft columns="3" rows="2"]` display
10. The `[ethereum-wallet-balance]` display with different settings
11. The `[ethereum-wallet-nft columns="3" rows="2"]` token info display
...
* NFT (ERC721) tokens display and sending support: `[ethereum-wallet-nft]` shortcode, and history table support is added.
