...
{
    $possible_screens['ipfs'] = esc_html( __( 'IPFS', 'ethereum-wallet' ) );
...
<tr valign="top">
<th scope="row"><?php 
    _e( "IPFS Gateway URL", 'ethereum-wallet' );
    ?></th>
<td><fieldset>
    <label>
        <input <?php 
    ...
    ?>">
        <p><?php 
    _e( 'The ipfs gateway used to show "ipfs://" URLs. The https://ipfs.io/ipfs/ is used by default.', 'ethereum-wallet' );
    ?></p>
        <p><?php 
    echo  sprintf(
        __( 'Pinning services like %5$s provide %3$shigh quality gateway service%4$s. %1$sPublic gateway services%2$s are also available', 'ethereum-wallet' ),
