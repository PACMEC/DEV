...
use Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\Types\TypeInterface;
class Template implements \Countable
{
     ...
     * @return Template
     */
    public function addItem(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\Types\TypeInterface $item) : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\Template
    {
        $this->template[] = $item;
        return $this;
    }
     ...
     */
    public function parse(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\Parser $parser) : array
    {
     ...
     */
    public function write(array $items) : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface
    {
