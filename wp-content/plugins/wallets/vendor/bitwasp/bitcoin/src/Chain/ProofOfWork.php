...
class ProofOfWork
{
     ...
     */
    public function __construct(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Math\Math $math, \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Chain\ParamsInterface $params)
    {
        $this->math = $math;
        $this->params = $params;
    }
     ...
     */
    public function getTargetHash(int $bits) : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface
    {
        return \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\Buffer::int(\gmp_strval($this->getTarget($bits), 10), 32);
    }
    /**
     * @param int $bits
     * @return string
     ...
     * @return bool
     */
    public function checkPow(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface $hash, int $nBits) : bool
    {
        $negative = \false;
        $overflow = \false;
     ...
     * @throws \Exception
     */
    public function checkHeader(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Block\BlockHeaderInterface $header) : bool
    {
