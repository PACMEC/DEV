...
interface InputSignerInterface
{
     ...
     * @return mixed
     */
    public function signStep(int $idx, \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Crypto\EcAdapter\Key\PrivateKeyInterface $privateKey, int $sigHashType = \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Transaction\SignatureHash\SigHash::ALL);
    /**
