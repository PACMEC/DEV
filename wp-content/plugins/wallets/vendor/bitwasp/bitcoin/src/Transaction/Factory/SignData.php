...
class SignData
{
     ...
     * @return $this
     */
    public function p2sh(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\ScriptInterface $redeemScript)
    {
        if ($redeemScript instanceof \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\WitnessScript) {
    ...
    {
        return $this->redeemScript instanceof \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\ScriptInterface;
    }
    /**
     * @return ScriptInterface
     */
    public function getRedeemScript() : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\ScriptInterface
    {
     ...
     * @return $this
     */
    public function p2wsh(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\ScriptInterface $witnessScript)
    {
    ...
    {
        return $this->witnessScript instanceof \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\ScriptInterface;
    }
    /**
     * @return ScriptInterface
     */
    public function getWitnessScript() : \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\ScriptInterface
    {
