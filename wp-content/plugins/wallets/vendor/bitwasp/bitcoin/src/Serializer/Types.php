...
namespace Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Serializer;

use Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\CachingTypeFactory;
...
class Types
{
    ...
    public static function factory()
    {
        static $factory;
        if (null === $factory) {
            $factory = new \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\CachingTypeFactory();
        }
        return $factory;
    }
    /**
