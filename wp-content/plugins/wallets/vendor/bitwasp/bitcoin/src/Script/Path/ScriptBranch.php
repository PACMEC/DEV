...
class ScriptBranch
{
     ...
     */
    public function __construct(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\ScriptInterface $fullScript, array $logicalPath, array $scriptSections)
    {
