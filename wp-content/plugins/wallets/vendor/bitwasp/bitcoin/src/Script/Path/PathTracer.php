...
class PathTracer
{
     ...
     */
    private function addToCurrent(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Parser\Operation $operation)
    {
     ...
     * @param Operation $operation
     */
    public function operation(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Parser\Operation $operation)
    {
        if ($this->done) {
