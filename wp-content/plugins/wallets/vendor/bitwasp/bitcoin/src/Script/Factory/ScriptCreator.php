...
class ScriptCreator
{
     ...
     */
    public function __construct(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Math\Math $math, \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Opcodes $opcodes, \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface $buffer = null)
    {
        if ($buffer !== null) {
     ...
     * @return $this
     */
    public function push(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface $data)
    {
        $length = $data->getSize();
        if ($length < \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Opcodes::OP_PUSHDATA1) {
            ...
            $opCode = \constant("\\Ethereumico\\EthereumWallet\\Dependencies\\" . "BitWasp\\Bitcoin\\Script\\Opcodes::OP_PUSHDATA" . $lengthSize);
     ...
     * @return $this
     */
    public function concat(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\ScriptInterface $script)
    {
    ...
    public function sequence(array $sequence)
    {
        ...
        foreach ($sequence as $operation) {
            ...
            } elseif ($operation instanceof \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Interpreter\Number) {
                $new->push($operation->getBuffer());
            } elseif ($operation instanceof \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface) {
                $new->push($operation);
            } elseif ($operation instanceof \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\ScriptInterface) {
    ...
    {
        if ($n === 0) {
            $this->script .= \chr(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Opcodes::OP_0);
        } else {
            if ($n === -1 || $n >= 1 && $n <= 16) {
                $this->script .= \chr(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\encodeOpN($n));
            } else {
                $this->push(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Interpreter\Number::int($n)->getBuffer());
            }
        }
        return $this;
    }
     ...
     * @return $this
     */
    public function data(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\BufferInterface ...$dataList)
    {
    ...
    {
        return new \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Script\Script(new \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\Buffer($this->script), $this->opcodes);
    }
}
