...
use Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Serializer\Key\PublicKeySerializer;
...
class PublicKey extends \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Crypto\EcAdapter\Key\Key implements \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Crypto\EcAdapter\Key\PublicKeyInterface
{
    /**
     * @var EcAdapter
     */
     ...
     */
    public function __construct(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Adapter\EcAdapter $ecAdapter, $secp256k1_pubkey_t, bool $compressed = \false)
    {
     ...
     * @return bool
     */
    private function doEquals(\Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Key\PublicKey $other) : bool
    {
    ...
    {
        $context = $this->ecAdapter->getContext();
        $bin = \Ethereumico\EthereumWallet\Dependencies\BitWasp\Buffertools\Buffer::int(\gmp_strval($tweak, 10), 32)->getBinary();
        ...
        return new \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Key\PublicKey($this->ecAdapter, $clone, $this->compressed);
    }
    /**
     * @param \GMP $tweak
     * @return KeyInterface
    ...
    {
        return (new \Ethereumico\EthereumWallet\Dependencies\BitWasp\Bitcoin\Crypto\EcAdapter\Impl\Secp256k1\Serializer\Key\PublicKeySerializer($this->ecAdapter))->serialize($this);
    }
}
