...
class BN implements \JsonSerializable
{
    ...
    {
        if ($number instanceof \Ethereumico\EthereumWallet\Dependencies\BN\BN) {
            $this->bi = $number->bi;
            $this->red = $number->red;
            return;
        }
        // Reduction context
        $this->red = null;
        if ($number instanceof \Ethereumico\EthereumWallet\Dependencies\BI\BigInteger) {
            $this->bi = $number;
            return;
        }
        if (\is_array($number)) {
        ...
        $this->bi = new \Ethereumico\EthereumWallet\Dependencies\BI\BigInteger($number, $base);
    }
    ...
    {
        return $num instanceof \Ethereumico\EthereumWallet\Dependencies\BN\BN;
    }
    ...
    public function iuor(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        $this->bi = $this->bi->binaryOr($num->bi);
        return $this;
    }
    public function ior(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
    ...
    // Or `num` with `this`
    public function _or(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->ucmp($num) > 0) {
    ...
    public function uor(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->ucmp($num) > 0) {
    ...
    public function iuand(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        $this->bi = $this->bi->binaryAnd($num->bi);
        return $this;
    }
    public function iand(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if (\assert_options(\ASSERT_ACTIVE)) {
            \assert(!$this->negative() && !$num->negative());
        }
    ...
    // And `num` with `this`
    public function _and(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->ucmp($num) > 0) {
    ...
    public function uand(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->ucmp($num) > 0) {
    ...
    public function iuxor(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        $this->bi = $this->bi->binaryXor($num->bi);
        return $this;
    }
    public function ixor(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if (\assert_options(\ASSERT_ACTIVE)) {
            \assert(!$this->negative() && !$num->negative());
        }
    ...
    // Xor `num` with `this`
    public function _xor(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->ucmp($num) > 0) {
    ...
    public function uxor(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->ucmp($num) > 0) {
    ...
    public function iadd(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        $this->bi = $this->bi->add($num->bi);
        return $this;
    }
    // Add `num` to `this`
    public function add(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        return $this->_clone()->iadd($num);
    }
    // Subtract `num` from `this` in-place
    public function isub(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        $this->bi = $this->bi->sub($num->bi);
        return $this;
    }
    // Subtract `num` from `this`
    public function sub(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        return $this->_clone()->isub($num);
    }
    // Multiply `this` by `num`
    public function mul(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        return $this->_clone()->imul($num);
    }
    // In-place Multiplication
    public function imul(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
    ...
    // Math.pow(`this`, `num`)
    public function pow(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        $res = clone $this;
    ...
    public function iushln($bits)
    {
        ...
        if ($bits < 54) {
            ...
            $this->bi = $this->bi->mul((new \Ethereumico\EthereumWallet\Dependencies\BI\BigInteger(2))->pow($bits));
        }
        return $this;
    }
    ...
    public function iushrn($bits, $hint = 0, &$extended = null)
    {
        ...
        if ($bits < 54) {
            ...
            $this->bi = $this->bi->div((new \Ethereumico\EthereumWallet\Dependencies\BI\BigInteger(2))->pow($bits));
        }
        return $this;
    }
    ...
    public function imaskn($bits)
    {
        ...
        return $this->iand(new \Ethereumico\EthereumWallet\Dependencies\BN\BN($mask, 2));
    }
    ...
    // Find `this` / `num`
    public function div(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if (\assert_options(\ASSERT_ACTIVE)) {
            \assert(!$num->isZero());
        }
    ...
    // Find `this` % `num`
    public function mod(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if (\assert_options(\ASSERT_ACTIVE)) {
            \assert(!$num->isZero());
        }
    ...
    public function umod(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if (\assert_options(\ASSERT_ACTIVE)) {
            \assert(!$num->isZero());
        }
    ...
    // Find Round(`this` / `num`)
    public function divRound(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if (\assert_options(\ASSERT_ACTIVE)) {
            \assert(!$num->isZero());
        }
    ...
    public function gcd(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        $res = clone $this;
        $res->bi = $this->bi->gcd($num->bi);
        return $res;
    }
    public function invm(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        $res = clone $this;
    ...
    {
        $tmp = (new \Ethereumico\EthereumWallet\Dependencies\BN\BN(1))->iushln($num);
        return $this->add($tmp);
    }
    ...
    // 0 - if `this` == `num`
    // -1 - if `this` < `num`
    public function cmp(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        return $this->bi->cmp($num->bi);
    }
    public function ucmp(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
    ...
    public function gt(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
    ...
    public function gte(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        return $this->cmp($num) >= 0;
    }
    ...
    public function lt(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        return $this->cmp($num) < 0;
    }
    ...
    public function lte(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        return $this->cmp($num) <= 0;
    }
    ...
    public function eq(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        return $this->cmp($num) === 0;
    }
    public function toRed(\Ethereumico\EthereumWallet\Dependencies\BN\Red &$ctx)
    {
        if ($this->red !== null) {
    ...
    public function _forceRed(\Ethereumico\EthereumWallet\Dependencies\BN\Red &$ctx)
    {
        $this->red = $ctx;
        return $this;
    }
    public function forceRed(\Ethereumico\EthereumWallet\Dependencies\BN\Red &$ctx)
    {
        if ($this->red !== null) {
            throw new \Exception("Already a number in reduction context");
        }
    ...
    public function redAdd(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->red === null) {
    ...
    public function redIAdd(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->red === null) {
    ...
    public function redSub(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->red === null) {
    ...
    public function redISub(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->red === null) {
    ...
    public function redShl(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->red === null) {
    ...
    public function redMul(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->red === null) {
    ...
    public function redIMul(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
        if ($this->red === null) {
    ...
    public function redPow(\Ethereumico\EthereumWallet\Dependencies\BN\BN $num)
    {
    ...
    {
        return new \Ethereumico\EthereumWallet\Dependencies\BN\Red($num);
    }
