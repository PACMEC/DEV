...
namespace Ethereumico\EthereumWallet\Dependencies\Elliptic\Curve\EdwardsCurve;

use Ethereumico\EthereumWallet\Dependencies\BN\BN;
class Point extends \Ethereumico\EthereumWallet\Dependencies\Elliptic\Curve\BaseCurve\Point
{
    public $x;
    public $y;
    public $z;
    ...
    function __construct($curve, $x = null, $y = null, $z = null, $t = null)
    {
        ...
        if ($x == null && $y == null && $z == null) {
            ...
            $this->z = $z ? new \Ethereumico\EthereumWallet\Dependencies\BN\BN($z, 16) : $this->curve->one;
            $this->t = $t ? new \Ethereumico\EthereumWallet\Dependencies\BN\BN($t, 16) : null;
            if (!$this->x->red) {
    ...
    {
        return new \Ethereumico\EthereumWallet\Dependencies\Elliptic\Curve\EdwardsCurve\Point($curve, isset($obj[0]) ? $obj[0] : null, isset($obj[1]) ? $obj[1] : null, isset($obj[2]) ? $obj[2] : null);
    }
    ...
    {
        return $this->curve->_wnafMulAdd(1, [$this, $p], [$k1, $k2], 2, \true);
    }
