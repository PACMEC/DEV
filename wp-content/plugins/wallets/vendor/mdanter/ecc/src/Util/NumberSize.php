...
namespace Ethereumico\EthereumWallet\Dependencies\Mdanter\Ecc\Util;
...
class NumberSize
{
     ...
     * @return float
     */
    public static function getCeiledByteSize(\Ethereumico\EthereumWallet\Dependencies\Mdanter\Ecc\Math\GmpMathInterface $adapter, \GMP $x) : float
    {
     ...
     * @return float
     */
    public static function getFlooredByteSize(\Ethereumico\EthereumWallet\Dependencies\Mdanter\Ecc\Math\GmpMathInterface $adapter, \GMP $x) : float
    {
        $log2 = self::bnNumBits($adapter, $x);
     ...
     */
    public static function bnNumBytes(\Ethereumico\EthereumWallet\Dependencies\Mdanter\Ecc\Math\GmpMathInterface $adapter, \GMP $x) : int
    {
     ...
     * @link https://www.openssl.org/docs/crypto/BN_num_bytes.html
     */
    public static function bnNumBits(\Ethereumico\EthereumWallet\Dependencies\Mdanter\Ecc\Math\GmpMathInterface $adapter, \GMP $x) : int
    {
        $zero = \gmp_init(0, 10);
