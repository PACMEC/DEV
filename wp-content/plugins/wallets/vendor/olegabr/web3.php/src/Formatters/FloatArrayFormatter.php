...
class FloatArrayFormatter implements \Ethereumico\EthereumWallet\Dependencies\Web3\Formatters\IFormatter
{
    /**
     * format
     *
    ...
    public static function format($value)
    {
        return \array_map(function ($v) {
            return \Ethereumico\EthereumWallet\Dependencies\Web3\Formatters\FloatFormatter::format($v);
        }, $value);
    }
}
