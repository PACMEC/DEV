...
class OptionalQuantityFormatter implements \Ethereumico\EthereumWallet\Dependencies\Web3\Formatters\IFormatter
{
    /**
     * format
     * 
    ...
    {
        if (\Ethereumico\EthereumWallet\Dependencies\Web3\Validators\TagValidator::validate($value)) {
            return $value;
        }
        return \Ethereumico\EthereumWallet\Dependencies\Web3\Formatters\QuantityFormatter::format($value);
    }
}
