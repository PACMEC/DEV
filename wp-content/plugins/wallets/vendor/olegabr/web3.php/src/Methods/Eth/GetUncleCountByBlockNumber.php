...
class GetUncleCountByBlockNumber extends \Ethereumico\EthereumWallet\Dependencies\Web3\Methods\EthMethod
{
    /**
     * validators
     * 
     * @var array
     */
    protected $validators = [[\Ethereumico\EthereumWallet\Dependencies\Web3\Validators\TagValidator::class, \Ethereumico\EthereumWallet\Dependencies\Web3\Validators\QuantityValidator::class]];
    /**
     * inputFormatters
     * 
     * @var array
