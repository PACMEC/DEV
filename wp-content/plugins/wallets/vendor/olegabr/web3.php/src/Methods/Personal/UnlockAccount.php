...
class UnlockAccount extends \Ethereumico\EthereumWallet\Dependencies\Web3\Methods\EthMethod
{
    /**
     * validators
     * 
     * @var array
     */
    protected $validators = [\Ethereumico\EthereumWallet\Dependencies\Web3\Validators\AddressValidator::class, \Ethereumico\EthereumWallet\Dependencies\Web3\Validators\StringValidator::class, \Ethereumico\EthereumWallet\Dependencies\Web3\Validators\QuantityValidator::class];
    /**
     * inputFormatters
     * 
     * @var array
     */
    protected $inputFormatters = [\Ethereumico\EthereumWallet\Dependencies\Web3\Formatters\AddressFormatter::class, \Ethereumico\EthereumWallet\Dependencies\Web3\Formatters\StringFormatter::class, \Ethereumico\EthereumWallet\Dependencies\Web3\Formatters\NumberFormatter::class];
    /**
     * outputFormatters
     * 
     * @var array
