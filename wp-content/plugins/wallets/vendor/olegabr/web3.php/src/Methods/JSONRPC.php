...
use Ethereumico\EthereumWallet\Dependencies\Web3\Methods\IRPC;
class JSONRPC implements \Ethereumico\EthereumWallet\Dependencies\Web3\Methods\IRPC
{
    /**
     * id
     * 
    ...
    public function toPayload()
    {
        ...
        $rpc = ['id' => $id, 'jsonrpc' => $this->rpcVersion, 'method' => $this->method];
