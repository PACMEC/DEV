...
class IPAddress extends \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\ASNObject implements \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Parsable
{
    ...
    public static function fromBinary(&$binaryData, &$offsetIndex = 0)
    {
        ...
        if ($contentLength != 4) {
            throw new \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Exception\ParserException("A FG\\X509\\SAN\\IPAddress should have a content length of 4. Extracted length was {$contentLength}", $offsetIndex);
        }
