...
class AlgorithmIdentifier extends \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Composite\AttributeTypeAndValue
{
    public function __construct($objectIdentifierString)
    {
        parent::__construct($objectIdentifierString, new \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Universal\NullObject());
    }
}
