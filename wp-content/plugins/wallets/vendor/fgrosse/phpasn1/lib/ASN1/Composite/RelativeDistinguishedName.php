...
use Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Exception\NotImplementedException;
...
class RelativeDistinguishedName extends \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Universal\Set
{
    /**
     * @param string|\FG\ASN1\Universal\ObjectIdentifier $objIdentifierString
     * @param \FG\ASN1\ASNObject $value
     */
    public function __construct($objIdentifierString, \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\ASNObject $value)
    {
        ...
        parent::__construct(new \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Composite\AttributeTypeAndValue($objIdentifierString, $value));
    }
    ...
    {
        throw new \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Exception\NotImplementedException();
    }
}
