...
use Exception;
abstract class AbstractString extends \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\ASNObject implements \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Parsable
{
    /** @var string */
    protected $value;
    ...
    protected function checkString()
    {
        ...
        for ($i = 0; $i < $stringLength; $i++) {
            if (\in_array($this->value[$i], $this->allowedCharacters) == \false) {
                $typeName = \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Identifier::getName($this->getType());
