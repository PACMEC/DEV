...
use DateTimeZone;
use Exception;
abstract class AbstractTime extends \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\ASNObject
{
    /** @var DateTime */
    protected $value;
    public function __construct($dateTime = null, $dateTimeZone = 'UTC')
    {
        if ($dateTime == null || \is_string($dateTime)) {
            ...
            if ($dateTimeObject == \false) {
                ...
                $className = \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Identifier::getName($this->getType());
