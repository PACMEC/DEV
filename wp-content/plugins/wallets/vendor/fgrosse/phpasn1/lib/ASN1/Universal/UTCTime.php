 ...
 */
class UTCTime extends \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\AbstractTime implements \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Parsable
{
    public function getType()
    {
        return \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Identifier::UTC_TIME;
    }
    ...
    {
        self::parseIdentifier($binaryData[$offsetIndex], \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Identifier::UTC_TIME, $offsetIndex++);
        ...
        if ($binaryData[$offsetIndex] == '+' || $binaryData[$offsetIndex] == '-') {
            ...
            throw new \Ethereumico\EthereumWallet\Dependencies\FG\ASN1\Exception\ParserException('Invalid UTC String', $offsetIndex);
        }
