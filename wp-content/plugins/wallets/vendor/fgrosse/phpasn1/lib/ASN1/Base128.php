...
class Base128
{
    ...
    {
        $value = \Ethereumico\EthereumWallet\Dependencies\FG\Utility\BigInteger::create($value);
    ...
    {
        $bitsPerOctet = 7;
        $value = \Ethereumico\EthereumWallet\Dependencies\FG\Utility\BigInteger::create(0);
        $i = 0;
        while (\true) {
            if (!isset($octets[$i])) {
