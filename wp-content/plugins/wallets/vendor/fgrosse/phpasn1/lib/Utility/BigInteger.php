 ...
 */
namespace Ethereumico\EthereumWallet\Dependencies\FG\Utility;
...
abstract class BigInteger
{
    ...
    public static function create($val)
    {
        if (self::$_prefer) {
            switch (self::$_prefer) {
                case 'gmp':
                    $ret = new \Ethereumico\EthereumWallet\Dependencies\FG\Utility\BigIntegerGmp();
                    break;
                case 'bcmath':
                    $ret = new \Ethereumico\EthereumWallet\Dependencies\FG\Utility\BigIntegerBcmath();
                    break;
                default:
