...
class Ed25519 extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards
{
    const HASH = 'sha512';
    /*
    ...
    */
    ...
    {
        // 2^255 - 19
        $this->setModulo(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger('7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFED', 16));
        $this->setCoefficients(
            // -1
            new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger('7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEC', 16),
            // a
            // -121665/121666
            new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger('52036CEE2B6FFE738CC740797779E89800700A4D4141D8AB75EB4DCA135978A3', 16)
        );
        $this->setBasePoint(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger('216936D3CD6E53FEC0A4E231FDD6DC5C692CC7609525A7B2C9562D608F25D51A', 16), new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger('6666666666666666666666666666666666666666666666666666666666666658', 16));
        $this->setOrder(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger('1000000000000000000000000000000014DEF9DEA2F79CD65812631A5CF5D3ED', 16));
    ...
    public function recoverX(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $y, $sign)
    {
        ...
        /* we don't do $x2->squareRoot() because, quoting from
                 ...
                 */
        $exp = $this->getModulo()->add(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(3));
        ...
        if (!$x->multiply($x)->subtract($x2)->equals($this->zero)) {
            $temp = $this->getModulo()->subtract(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(1));
    ...
    public function extractSecret($str)
    {
        ...
        $hash = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\Hash('sha512');
        $h = $hash->hash($str);
        $h = \substr($h, 0, 32);
    ...
    {
        return $this->extractSecret(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\Random::string(32));
    }
    /**
