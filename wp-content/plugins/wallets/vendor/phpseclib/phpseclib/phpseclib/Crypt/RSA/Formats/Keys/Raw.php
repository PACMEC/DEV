...
abstract class Raw
{
    ...
    public static function savePrivateKey(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $n, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $e, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $d, array $primes, array $exponents, array $coefficients, $password = '', array $options = [])
    {
        if (!empty($password) && \is_string($password)) {
            throw new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\RSA\Formats\Keys\UnsupportedFormatException('Raw private keys do not support encryption');
        }
