...
abstract class XML
{
    ...
    {
        return "<DSAKeyValue>\r\n" . '  <P>' . \Ethereumico\EthereumWallet\Dependencies\ParagonIE\ConstantTime\Base64::encode($p->toBytes()) . "</P>\r\n" . '  <Q>' . \Ethereumico\EthereumWallet\Dependencies\ParagonIE\ConstantTime\Base64::encode($q->toBytes()) . "</Q>\r\n" . '  <G>' . \Ethereumico\EthereumWallet\Dependencies\ParagonIE\ConstantTime\Base64::encode($g->toBytes()) . "</G>\r\n" . '  <Y>' . \Ethereumico\EthereumWallet\Dependencies\ParagonIE\ConstantTime\Base64::encode($y->toBytes()) . "</Y>\r\n" . '</DSAKeyValue>';
    }
}
