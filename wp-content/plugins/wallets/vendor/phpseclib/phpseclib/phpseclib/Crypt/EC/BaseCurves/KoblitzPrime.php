 ...
 * @access  public
 */
class KoblitzPrime extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\EC\BaseCurves\Prime
{
    ...
    public function multiplyAddPoints(array $points, array $scalars)
    {
        ...
        if (!isset($this->basis)) {
            $factory = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\PrimeField($this->order);
            $tempOne = $factory->newInteger($one);
            $tempTwo = $factory->newInteger($two);
            $tempThree = $factory->newInteger(new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(3));
     ...
     * @return BigInteger[]
     */
    protected static function extendedGCD(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $u, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $v)
    {
        $one = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(1);
