...
use Ethereumico\EthereumWallet\Dependencies\phpseclib3\Exceptions\NoKeyLoadedException;
 ...
 * @access  public
 */
class PrivateKey extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\RSA implements \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\Common\PrivateKey
{
     ...
     */
    protected function exponentiate(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $x)
    {
        switch (\true) {
        ...
        if (!static::$enableBlinding) {
            ...
            $r = \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger::randomRange(self::$one, $smallest->subtract(self::$one));
    ...
    private function emsa_pss_encode($m, $emBits)
    {
        ...
        $salt = \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\Random::string($sLen);
    ...
    public function getPublicKey()
    {
        ...
        return \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\RSA::loadFormat('PKCS8', $key)->withHash($this->hash->getHash())->withMGFHash($this->mgfHash->getHash())->withSaltLength($this->sLen)->withLabel($this->label)->withPadding($this->signaturePadding | $this->encryptionPadding);
    }
    /**
