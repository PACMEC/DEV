 ...
 * @access  public
 */
class TripleDES extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\DES
{
    /**
    ...
    public function __construct($mode)
    {
        switch (\strtolower($mode)) {
            ...
            case '3cbc':
                ...
                $this->des = [new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\DES('cbc'), new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\DES('cbc'), new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\DES('cbc')];
            ...
            default:
                ...
                if ($this->mode == self::MODE_STREAM) {
                    throw new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\BadModeException('Block ciphers cannot be ran in stream mode');
                }
        }
    }
    /**
