...
abstract class libsodium
{
     ...
     * @return string
     */
    public static function savePublicKey(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\EC\Curves\Ed25519 $curve, array $publicKey)
    {
     ...
     * @return string
     */
    public static function savePrivateKey(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $privateKey, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\EC\Curves\Ed25519 $curve, array $publicKey, $password = '')
    {
        ...
        if (!empty($password) && \is_string($password)) {
            throw new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Exception\UnsupportedFormatException('libsodium private keys do not support encryption');
        }
