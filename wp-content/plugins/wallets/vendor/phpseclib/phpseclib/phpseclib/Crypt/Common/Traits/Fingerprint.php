 ...
 */
namespace Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\Common\Traits;
...
trait Fingerprint
{
    ...
    public function getFingerprint($algorithm = 'md5')
    {
        ...
        switch ($algorithm) {
            case 'sha256':
                $hash = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\Hash('sha256');
