 ...
 * @access  public
 */
class DES extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\Common\BlockCipher
{
    /**
    ...
    {
        if (!$this instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Crypt\TripleDES && \strlen($key) != 8) {
