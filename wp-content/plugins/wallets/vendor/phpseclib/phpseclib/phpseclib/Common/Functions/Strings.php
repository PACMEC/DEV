 ...
 */
namespace Ethereumico\EthereumWallet\Dependencies\phpseclib3\Common\Functions;
...
abstract class Strings
{
    ...
    public static function unpackSSH2($format, &$data)
    {
        ...
        for ($i = 0; $i < \strlen($format); $i++) {
            ...
            switch ($format[$i]) {
                case 'i':
                    $result[] = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger($temp, -256);
                    break;
                case 's':
                    $result[] = $temp;
                    break;
        ...
        for ($i = 0; $i < \strlen($format); $i++) {
            ...
            switch ($format[$i]) {
                ...
                case 's':
                    ...
                    break;
                case 'i':
                    if (!$element instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger && !$element instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\Common\FiniteField\Integer) {
