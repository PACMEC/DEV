 ...
 */
namespace Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\PrimeField;

use Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\Common\FiniteField\Integer as Base;
 ...
 * @access  public
 */
class Integer extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\Common\FiniteField\Integer
{
    /**
     ...
     * Default constructor
     */
    public function __construct($instanceID, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $num = null)
    {
     ...
     */
    public static function setModulo($instanceID, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $modulo)
    {
    ...
    public static function setRecurringModuloFunction($instanceID, callable $function)
    {
        ...
        if (!isset(static::$zero)) {
            static::$zero = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger();
        }
    }
    /**
     ...
     * @return static
     */
    public function pow(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $x)
    {
        $temp = new static($this->instanceID);
    ...
    public function squareRoot()
    {
        ...
        $q = clone $p_1;
        $s = \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger::scan1divide($q);
        ...
        $m = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger($s);
    ...
    {
        return \Ethereumico\EthereumWallet\Dependencies\ParagonIE\ConstantTime\Hex::encode($this->toBytes());
    }
    /**
    ...
    {
        $w++;
        $mask = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger((1 << $w) - 1);
        $sub = new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger(1 << $w);
