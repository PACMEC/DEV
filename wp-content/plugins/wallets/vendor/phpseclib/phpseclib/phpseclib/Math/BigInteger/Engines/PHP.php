 ...
 * @access  public
 */
abstract class PHP extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\Engine
{
    /**#@+
     * Array constants
     *
    ...
    public function __construct($x = 0, $base = 10)
    {
        ...
        if (!static::$isValidEngine) {
            throw new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Exception\BadConfigurationException(static::class . ' is not setup correctly on this system');
        }
        $this->value = [];
    ...
    protected function initialize($base)
    {
        switch (\abs($base)) {
            case 16:
                ...
                $temp = new static(\Ethereumico\EthereumWallet\Dependencies\ParagonIE\ConstantTime\Hex::decode($x), 256);
     ...
     */
    protected function divideHelper(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $y)
    {
        if (\count($y->value) == 1) {
     ...
     * @return PHP
     */
    protected function normalize(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $result)
    {
     ...
     * @return PHP
     */
    protected function powModInner(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $e, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $n)
    {
        try {
            $class = static::$modexpEngine;
            return $class::powModHelper($this, $e, $n, static::class);
        } catch (\Exception $err) {
            return \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP\DefaultEngine::powModHelper($this, $e, $n, static::class);
        }
    }
    /**
     * Performs squaring
     ...
     * @return int
     */
    public static function scan1divide(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $r)
    {
        $r_value =& $r->value;
     ...
     * @return PHP
     */
    protected function powHelper(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $n)
    {
