...
class BigInteger
{
    ...
    {
        self::$engines = [];
        $fqmain = '\\Ethereumico\\EthereumWallet\\Dependencies\\' . 'phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
        ...
        if (!$fqmain::isValidEngine()) {
            throw new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Exception\BadConfigurationException("{$main} is not setup correctly on this system");
        }
        ...
        if (!$found) {
            throw new \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Exception\BadConfigurationException("No valid modular exponentiation engine found for {$main}");
        }
    ...
    public function __construct($x = 0, $base = 10)
    {
        ...
        if ($x instanceof self::$mainEngine) {
            $this->value = clone $x;
        } elseif ($x instanceof \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\Engine) {
     ...
     * @return BigInteger
     */
    public function add(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    function subtract(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function multiply(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger[]
     */
    public function divide(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @param BigInteger $n
     */
    public function modInverse(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @param BigInteger $n
     */
    public function extendedGCD(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function gcd(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function powMod(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $e, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function modPow(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $e, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @see self::equals()
     */
    public function compare(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return bool
     */
    public function equals(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_and(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_or(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_xor(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $x)
    {
     ...
     */
    public static function randomRangePrime(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $min, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function randomRange(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $min, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public function pow(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public static function min(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function max(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
        $nums = \array_map(function ($num) {
            return $num->value;
     ...
     * @return bool
     */
    public function between(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $min, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $max)
    {
     ...
     * @return int
     */
    public static function scan1divide(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $r)
    {
        $class = self::$mainEngine;
    ...
    public function createRecurringModuloFunction()
    {
        ...
        return function (\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger $x) use($func) {
