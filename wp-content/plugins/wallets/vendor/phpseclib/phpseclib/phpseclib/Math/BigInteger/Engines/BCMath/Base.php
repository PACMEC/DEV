 ...
 * @access  public
 */
abstract class Base extends \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath
{
    /**
     * Cache constants
     *
     ...
     */
    protected static function powModHelper(\Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath $x, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath $e, \Ethereumico\EthereumWallet\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath $n, $class)
    {
        if (empty($e->value)) {
            $temp = new $class();
            $temp->value = '1';
