 ...
 */
class Response implements \Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\ResponseInterface
{
    use MessageTrait;
    ...
    public function withStatus($code, $reasonPhrase = '') : \Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\ResponseInterface
    {
