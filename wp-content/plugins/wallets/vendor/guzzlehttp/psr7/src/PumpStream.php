 ...
 */
final class PumpStream implements \Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\StreamInterface
{
    /** @var callable|null */
    private $source;
    /** @var int|null */
    ...
    public function __construct(callable $source, array $options = [])
    {
        ...
        $this->buffer = new \Ethereumico\EthereumWallet\Dependencies\GuzzleHttp\Psr7\BufferStream();
    }
