...
final class StreamWrapper
{
     ...
     */
    public static function getResource(\Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\Ethereumico\EthereumWallet\Dependencies\Psr\Http\Message\StreamInterface $stream)
    {
