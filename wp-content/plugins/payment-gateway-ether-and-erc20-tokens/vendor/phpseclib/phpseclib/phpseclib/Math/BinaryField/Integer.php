 ...
 */
namespace Ethereumico\Epg\Dependencies\phpseclib3\Math\BinaryField;
...
class Integer extends \Ethereumico\Epg\Dependencies\phpseclib3\Math\Common\FiniteField\Integer
{
    ...
    private static function polynomialDivide($x, $y)
    {
        ...
        while (($degr = static::deg($r)) >= $d) {
            ...
            $s = \Ethereumico\Epg\Dependencies\phpseclib3\Math\BinaryField::base2ToBase256($s);
    ...
    private static function regularPolynomialMultiply($x, $y)
    {
        ...
        $x = \strrev(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BinaryField::base256ToBase2($x));
        $y = \strrev(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BinaryField::base256ToBase2($y));
        ...
        $result = \Ethereumico\Epg\Dependencies\phpseclib3\Math\BinaryField::base2ToBase256($result);
        $size = \strlen($result);
        $x = \strrev($x);
        // precompute left shift 1 through 7
        for ($i = 1; $i < 8; $i++) {
            $precomputed[$i] = \Ethereumico\Epg\Dependencies\phpseclib3\Math\BinaryField::base2ToBase256($x . \str_repeat('0', $i));
        }
    ...
    public function toBits()
    {
        ...
        return \Ethereumico\Epg\Dependencies\phpseclib3\Math\BinaryField::base256ToBase2($this->value);
    }
    /**
    ...
    {
        return new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger($this->value, 256);
    }
    /**
