 ...
 * @access  public
 */
abstract class Base extends \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP
{
    /**
     * Cache constants
     *
     ...
     */
    protected static function powModHelper(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $x, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $e, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $n, $class)
    {
        if (empty($e->value)) {
            $temp = new $class();
            $temp->value = [1];
