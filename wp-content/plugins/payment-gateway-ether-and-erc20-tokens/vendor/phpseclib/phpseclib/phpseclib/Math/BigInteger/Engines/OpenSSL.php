...
use Ethereumico\Epg\Dependencies\phpseclib3\Crypt\RSA\Formats\Keys\PKCS8;
...
abstract class OpenSSL
{
     ...
     * @return Engine
     */
    public static function powModHelper(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\Engine $x, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\Engine $e, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\Engine $n)
    {
        ...
        $key = \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\RSA\Formats\Keys\PKCS8::savePublicKey(new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger($n), new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger($e));
