 ...
 * @access  public
 */
abstract class Base extends \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath
{
    /**
     * Cache constants
     *
     ...
     */
    protected static function powModHelper(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath $x, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath $e, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath $n, $class)
    {
        if (empty($e->value)) {
            $temp = new $class();
            $temp->value = '1';
