...
{
    const MAP = [
        'type' => \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1::TYPE_SEQUENCE,
        'min' => 1,
        'max' => 4,
        // ub-domain-defined-attributes
        'children' => \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1\Maps\BuiltInDomainDefinedAttribute::MAP,
    ];
}
