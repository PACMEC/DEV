...
class X509
{
    ...
    public function getPublicKey()
    {
        ...
        switch ($keyinfo['algorithm']['algorithm']) {
            case 'id-RSASSA-PSS':
                return \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\RSA::loadFormat('PSS', $key);
            case 'rsaEncryption':
                return \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\RSA::loadFormat('PKCS8', $key)->withPadding(\Ethereumico\Epg\Dependencies\phpseclib3\Crypt\RSA::SIGNATURE_PKCS1);
            case 'id-ecPublicKey':
            case 'id-Ed25519':
            case 'id-Ed448':
