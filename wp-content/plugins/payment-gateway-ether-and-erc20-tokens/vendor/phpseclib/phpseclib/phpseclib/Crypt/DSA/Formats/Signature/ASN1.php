...
abstract class ASN1
{
    ...
    public static function load($sig)
    {
        ...
        $components = \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1::asn1map($decoded[0], \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1\Maps\DssSigValue::MAP);
        return $components;
    }
    /**
    ...
    {
        return \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1::encodeDER(\compact('r', 's'), \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1\Maps\DssSigValue::MAP);
    }
}
