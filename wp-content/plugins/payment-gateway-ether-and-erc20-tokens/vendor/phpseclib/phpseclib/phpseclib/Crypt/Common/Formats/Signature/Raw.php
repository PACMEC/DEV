 ...
 */
namespace Ethereumico\Epg\Dependencies\phpseclib3\Crypt\Common\Formats\Signature;
...
abstract class Raw
{
    ...
    public static function load($sig)
    {
        switch (\true) {
            ...
            case !$sig['r'] instanceof \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger:
            case !$sig['s'] instanceof \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger:
                return \false;
        }
