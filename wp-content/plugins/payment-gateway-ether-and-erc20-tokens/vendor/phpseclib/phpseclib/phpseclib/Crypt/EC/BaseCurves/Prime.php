 ...
 * @access  public
 */
class Prime extends \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\EC\BaseCurves\Base
{
    /**
    ...
    public function setModulo(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $modulo)
    {
        ...
        $this->two = $this->factory->newInteger(new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger(2));
        $this->three = $this->factory->newInteger(new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger(3));
        ...
        $this->four = $this->factory->newInteger(new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger(4));
        $this->eight = $this->factory->newInteger(new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger(8));
    }
    /**
     * Set coefficients a and b
     */
    public function setCoefficients(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $a, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $b)
    {
    ...
    {
        $y = \ord(\Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::shift($m));
        $x = new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger($m, 256);
     ...
     * @return int[]
     */
    private static function getJSFPoints(\Ethereumico\Epg\Dependencies\phpseclib3\Math\Common\FiniteField\Integer $k1, \Ethereumico\Epg\Dependencies\phpseclib3\Math\Common\FiniteField\Integer $k2)
    {
        static $three;
        if (!isset($three)) {
            $three = new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger(3);
        }
        $jsf = [[], []];
        $k1 = $k1->toBigInteger();
        $k2 = $k2->toBigInteger();
        $d1 = 0;
        $d2 = 0;
        while ($k1->compare(new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger(-$d1)) > 0 || $k2->compare(new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger(-$d2)) > 0) {
            // first phase
