...
abstract class PuTTY extends \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\Common\Formats\Keys\PuTTY
{
     ...
     * @access private
     */
    const PUBLIC_HANDLER = 'Ethereumico\\Epg\\Dependencies\\phpseclib3\\Crypt\\RSA\\Formats\\Keys\\OpenSSH';
    /**
    ...
    public static function load($key, $password = '')
    {
        ...
        $isPublicKey = \false;
        $result = \Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::unpackSSH2('ii', $public);
        if ($result === \false) {
            throw new \UnexpectedValueException('Key appears to be malformed');
        }
        list($publicExponent, $modulus) = $result;
        $result = \Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::unpackSSH2('iiii', $private);
        if ($result === \false) {
            throw new \UnexpectedValueException('Key appears to be malformed');
        }
        $primes = $coefficients = [];
    ...
    public static function savePrivateKey(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $n, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $e, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $d, array $primes, array $exponents, array $coefficients, $password = '', array $options = [])
    {
        ...
        $public = \Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::packSSH2('ii', $e, $n);
        $private = \Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::packSSH2('iiii', $d, $primes[1], $primes[2], $coefficients[2]);
    ...
    {
        return self::wrapPublicKey(\Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::packSSH2('ii', $e, $n), 'ssh-rsa');
    }
}
