...
abstract class MontgomeryPrivate
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $components['dA'] = new \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger($key, 256);
     ...
     * @return string
     */
    public static function savePrivateKey(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $privateKey, \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\EC\BaseCurves\Montgomery $curve, array $publicKey, $password = '')
    {
