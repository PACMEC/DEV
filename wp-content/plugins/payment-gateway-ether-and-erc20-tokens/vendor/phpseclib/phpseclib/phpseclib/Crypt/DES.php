 ...
 * @access  public
 */
class DES extends \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\Common\BlockCipher
{
    /**
    ...
    {
        if (!$this instanceof \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\TripleDES && \strlen($key) != 8) {
