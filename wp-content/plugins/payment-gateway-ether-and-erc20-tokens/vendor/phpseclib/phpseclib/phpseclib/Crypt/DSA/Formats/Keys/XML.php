...
abstract class XML
{
    ...
    {
        return "<DSAKeyValue>\r\n" . '  <P>' . \Ethereumico\Epg\Dependencies\ParagonIE\ConstantTime\Base64::encode($p->toBytes()) . "</P>\r\n" . '  <Q>' . \Ethereumico\Epg\Dependencies\ParagonIE\ConstantTime\Base64::encode($q->toBytes()) . "</Q>\r\n" . '  <G>' . \Ethereumico\Epg\Dependencies\ParagonIE\ConstantTime\Base64::encode($g->toBytes()) . "</G>\r\n" . '  <Y>' . \Ethereumico\Epg\Dependencies\ParagonIE\ConstantTime\Base64::encode($y->toBytes()) . "</Y>\r\n" . '</DSAKeyValue>';
    }
}
