...
abstract class libsodium
{
     ...
     * @return string
     */
    public static function savePrivateKey(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $privateKey, \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\EC\Curves\Ed25519 $curve, array $publicKey, $password = '')
    {
