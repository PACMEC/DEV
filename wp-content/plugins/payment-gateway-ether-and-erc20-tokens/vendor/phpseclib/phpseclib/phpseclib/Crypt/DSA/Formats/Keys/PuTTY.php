...
abstract class PuTTY extends \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\Common\Formats\Keys\PuTTY
{
     ...
     * @access private
     */
    const PUBLIC_HANDLER = 'Ethereumico\\Epg\\Dependencies\\phpseclib3\\Crypt\\DSA\\Formats\\Keys\\OpenSSH';
    /**
    ...
    public static function load($key, $password = '')
    {
        ...
        list($p, $q, $g, $y) = \Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::unpackSSH2('iiii', $public);
        list($x) = \Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::unpackSSH2('i', $private);
     ...
     * @return string
     */
    public static function savePrivateKey(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $p, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $q, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $g, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $y, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $x, $password = \false, array $options = [])
    {
        if ($q->getLength() != 160) {
            throw new \InvalidArgumentException('SSH only supports keys with an N (length of Group Order q) of 160');
        }
        $public = \Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::packSSH2('iiii', $p, $q, $g, $y);
        $private = \Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::packSSH2('i', $x);
    ...
    public static function savePublicKey(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $p, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $q, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $g, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $y)
    {
        ...
        return self::wrapPublicKey(\Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::packSSH2('iiii', $p, $q, $g, $y), 'ssh-dsa');
    }
}
