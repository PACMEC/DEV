...
abstract class Random
{
    ...
    public static function string($length)
    {
        ...
        if ($crypto === \false) {
            ...
            switch (\true) {
                case \class_exists('Ethereumico\\Epg\\Dependencies\\phpseclib3\\Crypt\\AES'):
                    $crypto = new \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\AES('ctr');
                    break;
                case \class_exists('Ethereumico\\Epg\\Dependencies\\phpseclib3\\Crypt\\Twofish'):
                    $crypto = new \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\Twofish('ctr');
                    break;
                case \class_exists('Ethereumico\\Epg\\Dependencies\\phpseclib3\\Crypt\\Blowfish'):
                    $crypto = new \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\Blowfish('ctr');
                    break;
                case \class_exists('Ethereumico\\Epg\\Dependencies\\phpseclib3\\Crypt\\TripleDES'):
                    $crypto = new \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\TripleDES('ctr');
                    break;
                case \class_exists('Ethereumico\\Epg\\Dependencies\\phpseclib3\\Crypt\\DES'):
                    $crypto = new \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\DES('ctr');
                    break;
                case \class_exists('Ethereumico\\Epg\\Dependencies\\phpseclib3\\Crypt\\RC4'):
                    $crypto = new \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\RC4();
                    break;
                default:
