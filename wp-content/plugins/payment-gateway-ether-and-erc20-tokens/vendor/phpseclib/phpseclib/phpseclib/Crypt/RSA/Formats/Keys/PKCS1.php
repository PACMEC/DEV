...
abstract class PKCS1 extends \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\Common\Formats\Keys\PKCS1
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $key = \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1::asn1map($decoded[0], \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1\Maps\RSAPrivateKey::MAP);
        if (\is_array($key)) {
        ...
        $key = \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1::asn1map($decoded[0], \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1\Maps\RSAPublicKey::MAP);
        if (!\is_array($key)) {
    ...
    public static function savePrivateKey(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $n, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $e, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $d, array $primes, array $exponents, array $coefficients, $password = '', array $options = [])
    {
        ...
        $key = \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1::encodeDER($key, \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1\Maps\RSAPrivateKey::MAP);
    ...
    public static function savePublicKey(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $n, \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $e)
    {
        ...
        $key = \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1::encodeDER($key, \Ethereumico\Epg\Dependencies\phpseclib3\File\ASN1\Maps\RSAPublicKey::MAP);
