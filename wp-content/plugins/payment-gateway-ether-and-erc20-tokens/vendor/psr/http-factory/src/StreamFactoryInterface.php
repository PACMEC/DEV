...
namespace Ethereumico\Epg\Dependencies\Psr\Http\Message;
...
interface StreamFactoryInterface
{
     ...
     */
    public function createStreamFromFile(string $filename, string $mode = 'r') : \Ethereumico\Epg\Dependencies\Psr\Http\Message\StreamInterface;
    /**
