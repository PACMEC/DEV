 ...
 * @license MIT
 */
namespace Ethereumico\Epg\Dependencies\Web3\Providers;

use Ethereumico\Epg\Dependencies\Web3\Providers\Provider;
use Ethereumico\Epg\Dependencies\Web3\Providers\IProvider;
use Ethereumico\Epg\Dependencies\Web3\RequestManagers\RequestManager;
class HttpProvider extends \Ethereumico\Epg\Dependencies\Web3\Providers\Provider implements \Ethereumico\Epg\Dependencies\Web3\Providers\IProvider
{
    /**
     * methods
     * 
     ...
     * @return void
     */
    public function __construct(\Ethereumico\Epg\Dependencies\Web3\RequestManagers\RequestManager $requestManager)
    {
