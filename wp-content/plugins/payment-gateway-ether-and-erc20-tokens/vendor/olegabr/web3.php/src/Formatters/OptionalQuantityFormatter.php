...
class OptionalQuantityFormatter implements \Ethereumico\Epg\Dependencies\Web3\Formatters\IFormatter
{
    /**
     * format
     * 
    ...
    {
        if (\Ethereumico\Epg\Dependencies\Web3\Validators\TagValidator::validate($value)) {
            return $value;
        }
        return \Ethereumico\Epg\Dependencies\Web3\Formatters\QuantityFormatter::format($value);
    }
}
