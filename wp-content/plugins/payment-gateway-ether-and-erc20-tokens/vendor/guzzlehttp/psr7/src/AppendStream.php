 ...
 */
final class AppendStream implements \Ethereumico\Epg\Dependencies\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\Ethereumico\Epg\Dependencies\Psr\Http\Message\StreamInterface $stream) : void
    {
