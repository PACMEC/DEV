...
class WP {
	...
	/**
	 * Parse request to find correct PACMEC query.
	 *
	...
	public function parse_request($extra_query_vars = '') {
		 ...
		 * @param WP           $this             Current PACMEC environment instance.
		 ...
		 * @since WP-2.1.0
		 *
		 * @param WP $this Current PACMEC environment instance (passed by reference).
		 */
	...
	public function handle_404() {
		 ...
		 * @param WP_Query $wp_query PACMEC Query object.
		 */
