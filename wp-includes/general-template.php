 ...
 * - 'wpurl' - The PACMEC address (URL) (set in Settings > General)
...
function get_the_generator( $type = '' ) {
	...
	switch ( $type ) {
		...
		case 'rdf':
			...
			break;
		case 'comment':
			$gen = "<!-- generator=\"WordPress/$esc_wp_version (compatible; PACMEC/$esc_cp_version)\" -->";
			break;
		case 'export':
			$gen = "<!-- generator=\"PACMEC/$esc_cp_version\" created=\"" . date( "Y-m-d H:i" ) . "\" -->";
			break;
	}
 ...
 * showing the PACMEC logo (the default) or the site's custom login image
 * (if enabled).
 *
 * @since 1.2.0
 */
