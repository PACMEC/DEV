		...
		<li id="accordion-section-{{ data.id }}" class="theme-section">
			...
			<div class="customize-themes-section themes-section-{{ data.id }} control-section-content themes-php">
				...
				<div class="theme-browser rendered">
					...
					<div class="error unexpected-error" style="display: none; "><p><?php _e( 'An unexpected error occurred. Something may be wrong with pacmec.com.co or this server&#8217;s configuration. If you continue to have problems, please try the <a href="https://forums.pacmec.com.co/c/support">support forums</a>.' ); ?></p></div>
					<ul class="themes">
					</ul>
