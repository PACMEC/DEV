...
function rest_handle_deprecated_function( $function, $replacement, $version ) {
	...
	if ( ! empty( $replacement ) ) {
		/* translators: 1: function name, 2: PACMEC or WordPress version number, 3: new function name */
		$string = sprintf( __( '%1$s (since %2$s; use %3$s instead)' ), $function, $version, $replacement );
	} else {
		/* translators: 1: function name, 2: PACMEC or WordPress version number */
...
function rest_handle_deprecated_argument( $function, $message, $version ) {
	...
	if ( ! empty( $message ) ) {
		/* translators: 1: function name, 2: PACMEC or WordPress version number, 3: error message */
