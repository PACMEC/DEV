(function () {
	...
	var editAttachmentMetadata = function() { // PACMEC: defer loading via require()
	...
	var manage$1 = function() { // PACMEC: defer loading via require()
	...
	var detailsTwoColumn = function() { // PACMEC: defer loading via require()
	...
	var manage = function() { // PACMEC: defer loading via require()
	...
	var editImageDetails = function() { // PACMEC: defer loading via require()
	...
	var editAttachments = function() { // PACMEC: defer loading via require()
	...
	var selectModeToggle = function() { // PACMEC: defer loading via require()
	...
	var deleteSelected = function() { // PACMEC: defer loading via require()
	...
	var deleteSelectedPermanently = function() { // PACMEC: defer loading via require()
