(function () {
	...
	var postMedia = function() { // PACMEC: defer loading via require()
	...
	var audioDetails$2 = function() { // PACMEC: defer loading via require()
	...
	var videoDetails$2 = function() { // PACMEC: defer loading via require()
	...
	var mediaDetails$1 = function() { // PACMEC: defer loading via require()
	...
	var audioDetails$1 = function() { // PACMEC: defer loading via require()
	...
	var videoDetails$1 = function() { // PACMEC: defer loading via require()
	...
	var mediaDetails = function() { // PACMEC: defer loading via require()
	...
	var audioDetails = function() { // PACMEC: defer loading via require()
	...
	var videoDetails = function() { // PACMEC: defer loading via require()
