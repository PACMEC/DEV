(function () {
	...
	var region = function() { // PACMEC: defer loading via require()
	...
	var stateMachine = function() { // PACMEC: defer loading via require()
	...
	var state = function() { // PACMEC: defer loading via require()
	...
	var selectionSync = function() { // PACMEC: defer loading via require()
	...
	var library$1 = function() { // PACMEC: defer loading via require()
	...
	var imageDetails$2 = function() { // PACMEC: defer loading via require()
	...
	var galleryEdit = function() { // PACMEC: defer loading via require()
	...
	var galleryAdd = function() { // PACMEC: defer loading via require()
	...
	var collectionEdit = function() { // PACMEC: defer loading via require()
	...
	var collectionAdd = function() { // PACMEC: defer loading via require()
	...
	var featuredImage = function() { // PACMEC: defer loading via require()
	...
	var replaceImage = function() { // PACMEC: defer loading via require()
	...
	var editImage$1 = function() { // PACMEC: defer loading via require()
	...
	var mediaLibrary = function() { // PACMEC: defer loading via require()
	...
	var embed$2 = function() { // PACMEC: defer loading via require()
	...
	var cropper$1 = function() { // PACMEC: defer loading via require()
	...
	var customizeImageCropper = function() { // PACMEC: defer loading via require()
	...
	var siteIconCropper$1 = function() { // PACMEC: defer loading via require()
	...
	var view = function() { // PACMEC: defer loading via require()
	...
	var frame = function() { // PACMEC: defer loading via require()
	...
	var mediaFrame = function() { // PACMEC: defer loading via require()
	...
	var select$1 = function() { // PACMEC: defer loading via require()
	...
	var post = function() { // PACMEC: defer loading via require()
	...
	var imageDetails$1 = function() { // PACMEC: defer loading via require()
	...
	var modal = function() { // PACMEC: defer loading via require()
	...
	var focusManager = function() { // PACMEC: defer loading via require()
	...
	var window$1 = function() { // PACMEC: defer loading via require()
	...
	var editor = function() { // PACMEC: defer loading via require()
	...
	var inline = function() { // PACMEC: defer loading via require()
	...
	var status = function() { // PACMEC: defer loading via require()
	...
	var statusError = function() { // PACMEC: defer loading via require()
	...
	var toolbar = function() { // PACMEC: defer loading via require()
	...
	var select = function() { // PACMEC: defer loading via require()
	...
	var embed$1 = function() { // PACMEC: defer loading via require()
	...
	var button = function() { // PACMEC: defer loading via require()
	...
	var buttonGroup = function() { // PACMEC: defer loading via require()
	...
	var priorityList = function() { // PACMEC: defer loading via require()
	...
	var menuItem = function() { // PACMEC: defer loading via require()
	...
	var menu = function() { // PACMEC: defer loading via require()
	...
	var routerItem = function() { // PACMEC: defer loading via require()
	...
	var router = function() { // PACMEC: defer loading via require()
	...
	var sidebar = function() { // PACMEC: defer loading via require()
	...
	var attachment = function() { // PACMEC: defer loading via require()
	...
	var library = function() { // PACMEC: defer loading via require()
	...
	var editLibrary = function() { // PACMEC: defer loading via require()
	...
	var attachments = function() { // PACMEC: defer loading via require()
	...
	var search = function() { // PACMEC: defer loading via require()
	...
	var attachmentFilters = function() { // PACMEC: defer loading via require()
	...
	var date = function() { // PACMEC: defer loading via require()
	...
	var uploaded = function() { // PACMEC: defer loading via require()
	...
	var all = function() { // PACMEC: defer loading via require()
	...
	var browser = function() { // PACMEC: defer loading via require()
	...
	var selection$2 = function() { // PACMEC: defer loading via require()
	...
	var selection$1 = function() { // PACMEC: defer loading via require()
	...
	var selection = function() { // PACMEC: defer loading via require()
	...
	var editSelection = function() { // PACMEC: defer loading via require()
	...
	var settings = function() { // PACMEC: defer loading via require()
	...
	var attachmentDisplay = function() { // PACMEC: defer loading via require()
	...
	var gallery = function() { // PACMEC: defer loading via require()
	...
	var playlist = function() { // PACMEC: defer loading via require()
	...
	var details = function() { // PACMEC: defer loading via require()
	...
	var attachmentCompat = function() { // PACMEC: defer loading via require()
	...
	var iframe = function() { // PACMEC: defer loading via require()
	...
	var embed = function() { // PACMEC: defer loading via require()
	...
	var label = function() { // PACMEC: defer loading via require()
	...
	var url = function() { // PACMEC: defer loading via require()
	...
	var link = function() { // PACMEC: defer loading via require()
	...
	var image = function() { // PACMEC: defer loading via require()
	...
	var imageDetails = function() { // PACMEC: defer loading via require()
	...
	var cropper = function() { // PACMEC: defer loading via require()
	...
	var siteIconCropper = function() { // PACMEC: defer loading via require()
	...
	var siteIconPreview = function() { // PACMEC: defer loading via require()
	...
	var editImage = function() { // PACMEC: defer loading via require()
	...
	var spinner = function() { // PACMEC: defer loading via require()
