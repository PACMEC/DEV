...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	$cp_logo_src = includes_url( 'images/pacmec-logo-dashicon-grey-on-transparent.svg' );
	$wp_logo_menu_args = array(
		'id'    => 'wp-logo',
		'title' => (
			'<img class="cp-logo" src="' . $cp_logo_src . '" alt="PACMEC logo" />'
			. '<span class="screen-reader-text">' . __( 'About PACMEC' ) . '</span>'
		),
		'href'  => $about_url,
	);
