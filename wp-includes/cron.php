 ...
 *
 * Schedules an event which will execute once by the PACMEC actions core at
 * a time which you specify. The action will fire off when someone visits your
 * PACMEC site, if the schedule time has passed.
 *
 ...
 *
 * Schedules a hook which will be executed by the PACMEC actions core on a
 * specific interval, specified by you. The action will trigger when someone
 * visits your PACMEC site, if the scheduled time has passed.
 *
