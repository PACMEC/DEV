...
function _print_emoji_detection_script() {
	...
	if ( SCRIPT_DEBUG ) {
		$version_wpemoji = 'ver=' . pacmec_asset_version( 'script', 'wpemoji' );
		$version_twemoji = 'ver=' . pacmec_asset_version( 'script', 'twemoji' );
		...
		$version = 'ver=' . pacmec_asset_version( 'script', 'concatemoji' );
		$settings['source'] = array(
			/** This filter is documented in wp-includes/class.wp-scripts.php */
