 ...
 *
 * @since WP-2.7.0
 * @since WP-4.6.0 Return value changed from an array to an Requests_Utility_CaseInsensitiveDictionary instance.
 *
...
/**
 * Returns the PACMEC User-Agent header for outgoing requests.
 *
 ...
 * come from WordPress, PACMEC uses the same pattern, but uses the URL to
 * indicate that requests come from a PACMEC site.
 *
 * @since 1.0.0
 *
 * @param bool $include_site_id Whether to include a site identifier (used when
 *                              communicating with the PACMEC API).  This
