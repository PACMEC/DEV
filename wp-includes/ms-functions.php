...
function wpmu_signup_blog_notification( $domain, $path, $title, $user_login, $user_email, $key, $meta = array() ) {
	...
	$from_name = get_site_option( 'site_name' ) == '' ? 'PACMEC' : esc_html( get_site_option( 'site_name' ) );
...
function maybe_add_existing_user_to_blog() {
	...
	wp_die( sprintf( __( 'You have been added to this site. Please visit the <a href="%s">homepage</a> or <a href="%s">log in</a> using your username and password.' ), home_url(), admin_url() ), __( 'PACMEC &rsaquo; Success' ), array( 'response' => 200 ) );
}
